...
const lnkfish$$level_sequence = [{ obstacle_type: 0, x_position: 200, delay: 1.5 }, { obstacle_type: 1, x_position: 500, delay: 1 }, { obstacle_type: 0, x_position: 350, delay: 1.5 }, { obstacle_type: 1, x_position: 250, delay: 1 }, { obstacle_type: 0, x_position: 350, delay: 1.5 }, { obstacle_type: 1, x_position: 400, delay: 1 }, { obstacle_type: 0, x_position: 200, delay: 1.5 }, { obstacle_type: 1, x_position: 500, delay: 1 }, { obstacle_type: 0, x_position: 350, delay: 1.5 }, { obstacle_type: 1, x_position: 250, delay: 1 }, { obstacle_type: 0, x_position: 350, delay: 1.5 }, { obstacle_type: 1, x_position: 400, delay: 1 }, { obstacle_type: 0, x_position: 350, delay: 1.5 }, { obstacle_type: 0, x_position: 200, delay: 1.5 }, { obstacle_type: 1, x_position: 400, delay: 1 }, { obstacle_type: 0, x_position: 350, delay: 1.5 }, { obstacle_type: 1, x_position: 400, delay: 1 }];
...
const lnkfish$$visual_entity = moonbitlang$core$ref$$Ref$new$16$(undefined);
const lnkfish$$black_obstacle_layer = Milky2018$selene$collision$$CollisionLayer$new();
const lnkfish$$initial_offsets = moonbitlang$core$builtin$$Map$new$46$inner$17$(8);
...
const lnkfish$$collider_entities = moonbitlang$core$ref$$Ref$new$19$(moonbitlang$core$array$$Array$new$46$inner$4$(0));
const lnkfish$$white_obstacle_layer = Milky2018$selene$collision$$CollisionLayer$new();
const lnkfish$$current_rotation_speed = moonbitlang$core$ref$$Ref$new$20$(0);
const lnkfish$$game_state = moonbitlang$core$ref$$Ref$new$21$(0);
const lnkfish$$level_current_index = moonbitlang$core$ref$$Ref$new$18$(0);
const lnkfish$$ui_entities = moonbitlang$core$ref$$Ref$new$19$(moonbitlang$core$array$$Array$new$46$inner$4$(0));
const lnkfish$$current_angle = moonbitlang$core$ref$$Ref$new$20$(0);
const lnkfish$$game_won_timer_set = moonbitlang$core$ref$$Ref$new$22$(false);
const lnkfish$$obstacle_spawn_timer = moonbitlang$core$ref$$Ref$new$20$(0);
const lnkfish$$obstacle_entities = moonbitlang$core$ref$$Ref$new$19$(moonbitlang$core$array$$Array$new$46$inner$4$(0));
...
const lnkfish$$white_obstacle_hit_picture = Milky2018$selene$sprite$$Picture$new({ _0: 160, _1: 160 }, "assets/white1_hit.png", undefined, undefined);
const lnkfish$$black_obstacle_hit_picture = Milky2018$selene$sprite$$Picture$new({ _0: 240, _1: 90 }, "assets/black1_hit.png", undefined, undefined);
const lnkfish$$obstacles = moonbitlang$core$builtin$$Map$new$46$inner$23$(8);
const lnkfish$$black_obstacle_picture = Milky2018$selene$sprite$$Picture$new({ _0: 240, _1: 90 }, "assets/black1.png", undefined, undefined);
const lnkfish$$white_obstacle_picture = Milky2018$selene$sprite$$Picture$new({ _0: 160, _1: 160 }, "assets/white1.png", undefined, undefined);
...
function moonbitlang$core$builtin$$Logger$write_object$29$(self, obj) {
  moonbitlang$core$builtin$$Show$output$29$(obj, self);
}
...
function moonbitlang$core$builtin$$Show$to_string$34$(self) {
  ...
  moonbitlang$core$builtin$$Show$output$4$(self, { self: logger, method_0: moonbitlang$core$builtin$$Logger$write_string$30$, method_1: moonbitlang$core$builtin$$Logger$write_substring$30$, method_2: moonbitlang$core$builtin$$Logger$write_char$30$ });
  return logger.val;
}
...
function moonbitlang$core$int$$Int$output_size_hint$46$inner(radix) {
  return radix >= 2 && radix < 7 ? 36 : radix >= 8 && radix < 15 ? 18 : radix >= 16 && radix <= 36 ? 10 : moonbitlang$core$abort$$abort$18$("radix must be between 2 and 36");
}
...
function moonbitlang$core$builtin$$Show$output$29$(self, logger) {
...
function moonbitlang$core$builtin$$Map$set$7$(self, key, value) {
  moonbitlang$core$builtin$$Map$set_with_hash$7$(self, key, value, moonbitlang$core$builtin$$Hash$hash$34$(key));
}
...
function moonbitlang$core$builtin$$Map$set$10$(self, key, value) {
  moonbitlang$core$builtin$$Map$set_with_hash$10$(self, key, value, moonbitlang$core$builtin$$Hash$hash$34$(key));
}
...
function moonbitlang$core$builtin$$Map$set$13$(self, key, value) {
  moonbitlang$core$builtin$$Map$set_with_hash$13$(self, key, value, moonbitlang$core$builtin$$Hash$hash$36$(key));
}
...
function moonbitlang$core$builtin$$Map$remove$7$(self, key) {
  moonbitlang$core$builtin$$Map$remove_with_hash$7$(self, key, moonbitlang$core$builtin$$Hash$hash$34$(key));
}
...
function moonbitlang$core$array$$ArrayView$at$25$(self, index) {
  if (index >= 0 && index < self.len) {
    ...
    return moonbitlang$core$abort$$abort$25$(`index out of bounds: the len is from 0 to ${moonbitlang$core$builtin$$Show$to_string$18$(self.len)} but the index is ${moonbitlang$core$builtin$$Show$to_string$18$(index)}`);
  }
}
function moonbitlang$core$array$$ArrayView$at$27$(self, index) {
  if (index >= 0 && index < self.len) {
    ...
    return moonbitlang$core$abort$$abort$27$(`index out of bounds: the len is from 0 to ${moonbitlang$core$builtin$$Show$to_string$18$(self.len)} but the index is ${moonbitlang$core$builtin$$Show$to_string$18$(index)}`);
  }
}
function moonbitlang$core$array$$ArrayView$swap$25$(self, i, j) {
  if (i >= 0 && (i < self.len && (j >= 0 && j < self.len))) {
    ...
    moonbitlang$core$abort$$abort$24$(`index out of bounds: the len is from 0 to ${moonbitlang$core$builtin$$Show$to_string$18$(self.len)} but the index is (${moonbitlang$core$builtin$$Show$to_string$18$(i)}, ${moonbitlang$core$builtin$$Show$to_string$18$(j)})`);
    return;
  }
}
...
function moonbitlang$core$array$$ArrayView$sub$46$inner$25$(self, start, end) {
  const len = self.len;
  let end$2;
  if (end === undefined) {
    end$2 = len;
  ...
  return start$2 >= 0 && (start$2 <= end$2 && end$2 <= len) ? { buf: self.buf, start: self.start + start$2 | 0, len: end$2 - start$2 | 0 } : moonbitlang$core$abort$$abort$26$("View index out of bounds");
}
function moonbitlang$core$array$$ArrayView$sub$46$inner$27$(self, start, end) {
  const len = self.len;
  let end$2;
  if (end === undefined) {
    end$2 = len;
  ...
  const start$2 = start < 0 ? len + start | 0 : start;
  return start$2 >= 0 && (start$2 <= end$2 && end$2 <= len) ? { buf: self.buf, start: self.start + start$2 | 0, len: end$2 - start$2 | 0 } : moonbitlang$core$abort$$abort$28$("View index out of bounds");
}
...
function moonbitlang$core$array$$Array$contains$49$(self, value) {
...
function moonbitlang$core$array$$bubble_sort_by$25$(arr, cmp) {
  ...
  while (true) {
    ...
    if (i < _end1071) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j > 0 && cmp(moonbitlang$core$array$$ArrayView$at$25$(arr, j - 1 | 0), moonbitlang$core$array$$ArrayView$at$25$(arr, j)) > 0) {
...
function moonbitlang$core$array$$bubble_sort_by$27$(arr, cmp) {
  const _end1071 = arr.len;
  let _tmp = 1;
  while (true) {
    const i = _tmp;
    if (i < _end1071) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j > 0 && cmp(moonbitlang$core$array$$ArrayView$at$27$(arr, j - 1 | 0), moonbitlang$core$array$$ArrayView$at$27$(arr, j)) > 0) {
...
function moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1194(_env, a, b) {
  const swaps = _env._2;
  const arr = _env._1;
  const cmp = _env._0;
  if (cmp(moonbitlang$core$array$$ArrayView$at$25$(arr, a), moonbitlang$core$array$$ArrayView$at$25$(arr, b)) > 0) {
...
function moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1195(_env, a, b, c) {
  moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1194(_env, a, b);
  moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1194(_env, b, c);
  moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1194(_env, a, b);
}
function moonbitlang$core$array$$choose_pivot_by$25$(arr, cmp) {
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1195(_env, a - 1 | 0, a, a + 1 | 0);
      moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1195(_env, b - 1 | 0, b, b + 1 | 0);
      moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1195(_env, c - 1 | 0, c, c + 1 | 0);
    }
    moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1195(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1214(_env, a, b) {
  const swaps = _env._2;
  const arr = _env._1;
  const cmp = _env._0;
  if (cmp(moonbitlang$core$array$$ArrayView$at$27$(arr, a), moonbitlang$core$array$$ArrayView$at$27$(arr, b)) > 0) {
...
function moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1215(_env, a, b, c) {
  moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1214(_env, a, b);
  moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1214(_env, b, c);
  moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$1214(_env, a, b);
}
function moonbitlang$core$array$$choose_pivot_by$27$(arr, cmp) {
  const len = arr.len;
  const swaps = { val: 0 };
  const b = Math.imul(len / 4 | 0, 2) | 0;
  if (len >= 8) {
    ...
    const _env = { _0: cmp, _1: arr, _2: swaps };
    if (len > 50) {
      moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1215(_env, a - 1 | 0, a, a + 1 | 0);
      moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1215(_env, b - 1 | 0, b, b + 1 | 0);
      moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1215(_env, c - 1 | 0, c, c + 1 | 0);
    }
    moonbitlang$core$array$$choose_pivot_by$46$sort_3$47$1215(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function moonbitlang$core$array$$sift_down_by$25$(arr, index, cmp) {
  ...
  while (true) {
    if (child < len) {
      if ((child + 1 | 0) < len && cmp(moonbitlang$core$array$$ArrayView$at$25$(arr, child), moonbitlang$core$array$$ArrayView$at$25$(arr, child + 1 | 0)) < 0) {
        child = child + 1 | 0;
      }
      if (cmp(moonbitlang$core$array$$ArrayView$at$25$(arr, index$2), moonbitlang$core$array$$ArrayView$at$25$(arr, child)) >= 0) {
        return undefined;
      }
...
function moonbitlang$core$array$$sift_down_by$27$(arr, index, cmp) {
  let index$2 = index;
  const len = arr.len;
  let child = (Math.imul(index$2, 2) | 0) + 1 | 0;
  while (true) {
    if (child < len) {
      if ((child + 1 | 0) < len && cmp(moonbitlang$core$array$$ArrayView$at$27$(arr, child), moonbitlang$core$array$$ArrayView$at$27$(arr, child + 1 | 0)) < 0) {
        child = child + 1 | 0;
      }
      if (cmp(moonbitlang$core$array$$ArrayView$at$27$(arr, index$2), moonbitlang$core$array$$ArrayView$at$27$(arr, child)) >= 0) {
        return undefined;
      }
...
function moonbitlang$core$array$$heap_sort_by$25$(arr, cmp) {
  ...
  while (true) {
    ...
    if (i > 0) {
      ...
      moonbitlang$core$array$$sift_down_by$25$(moonbitlang$core$array$$ArrayView$sub$46$inner$25$(arr, 0, i), 0, cmp);
      _tmp$2 = i - 1 | 0;
      continue;
    } else {
      return;
...
function moonbitlang$core$array$$heap_sort_by$27$(arr, cmp) {
  const len = arr.len;
  let _tmp = (len / 2 | 0) - 1 | 0;
  while (true) {
    const i = _tmp;
    if (i >= 0) {
      moonbitlang$core$array$$sift_down_by$27$(arr, i, cmp);
      _tmp = i - 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (i > 0) {
      ...
      moonbitlang$core$array$$sift_down_by$27$(moonbitlang$core$array$$ArrayView$sub$46$inner$27$(arr, 0, i), 0, cmp);
      _tmp$2 = i - 1 | 0;
      continue;
    } else {
      return;
...
function moonbitlang$core$array$$partition_by$25$(arr, cmp, pivot_index) {
  ...
  const pivot = moonbitlang$core$array$$ArrayView$at$25$(arr, arr.len - 1 | 0);
  let i = 0;
  ...
  while (true) {
    const j = _tmp;
    if (j < _end1064) {
      if (cmp(moonbitlang$core$array$$ArrayView$at$25$(arr, j), pivot) < 0) {
        if (i !== j) {
...
function moonbitlang$core$array$$partition_by$27$(arr, cmp, pivot_index) {
  moonbitlang$core$array$$ArrayView$swap$27$(arr, pivot_index, arr.len - 1 | 0);
  const pivot = moonbitlang$core$array$$ArrayView$at$27$(arr, arr.len - 1 | 0);
  let i = 0;
  let partitioned = true;
  const _end1064 = arr.len - 1 | 0;
  let _tmp = 0;
  while (true) {
    const j = _tmp;
    if (j < _end1064) {
      if (cmp(moonbitlang$core$array$$ArrayView$at$27$(arr, j), pivot) < 0) {
        if (i !== j) {
...
function moonbitlang$core$array$$try_bubble_sort_by$27$(arr, cmp) {
  let tries = 0;
  const _end1081 = arr.len;
  let _tmp = 1;
  while (true) {
...
function moonbitlang$core$array$$quick_sort_by$25$(arr, cmp, pred, limit) {
  ...
  while (true) {
    ...
    const _bind$8 = moonbitlang$core$array$$choose_pivot_by$25$(arr$2, cmp);
    ...
    const _bind$9 = moonbitlang$core$array$$partition_by$25$(arr$2, cmp, _pivot_index);
    ...
    if (_bind$10 === undefined) {
      ...
      const _pred = _Some;
      if (cmp(_pred, moonbitlang$core$array$$ArrayView$at$25$(arr$2, _pivot)) === 0) {
        let i = _pivot;
        while (true) {
          if (i < len && cmp(_pred, moonbitlang$core$array$$ArrayView$at$25$(arr$2, i)) === 0) {
            i = i + 1 | 0;
            continue;
          } else {
            break;
        ...
        arr$2 = moonbitlang$core$array$$ArrayView$sub$46$inner$25$(arr$2, i, len);
        continue;
      }
    }
    const left = moonbitlang$core$array$$ArrayView$sub$46$inner$25$(arr$2, 0, _pivot);
    const right = moonbitlang$core$array$$ArrayView$sub$46$inner$25$(arr$2, _pivot + 1 | 0, len);
    if (left.len < right.len) {
      moonbitlang$core$array$$quick_sort_by$25$(left, cmp, pred$2, limit$2);
      pred$2 = moonbitlang$core$array$$ArrayView$at$25$(arr$2, _pivot);
      arr$2 = right;
    } else {
      moonbitlang$core$array$$quick_sort_by$25$(right, cmp, moonbitlang$core$array$$ArrayView$at$25$(arr$2, _pivot), limit$2);
      arr$2 = left;
    }
    continue;
  }
}
function moonbitlang$core$array$$quick_sort_by$27$(arr, cmp, pred, limit) {
  let limit$2 = limit;
  let arr$2 = arr;
  let pred$2 = pred;
  let was_partitioned = true;
  ...
  while (true) {
    ...
    if (len <= 16) {
      if (len >= 2) {
        moonbitlang$core$array$$bubble_sort_by$27$(arr$2, cmp);
      }
      return undefined;
    }
    if (limit$2 === 0) {
      moonbitlang$core$array$$heap_sort_by$27$(arr$2, cmp);
      return undefined;
    }
    const _bind$8 = moonbitlang$core$array$$choose_pivot_by$27$(arr$2, cmp);
    const _pivot_index = _bind$8._0;
    const _likely_sorted = _bind$8._1;
    if (was_partitioned && (balanced && _likely_sorted)) {
      if (moonbitlang$core$array$$try_bubble_sort_by$27$(arr$2, cmp)) {
        return undefined;
      }
    }
    const _bind$9 = moonbitlang$core$array$$partition_by$27$(arr$2, cmp, _pivot_index);
    const _pivot = _bind$9._0;
    const _partitioned = _bind$9._1;
    was_partitioned = _partitioned;
    const _p$2 = len - _pivot | 0;
    ...
    if (_bind$10 === undefined) {
      ...
      const _Some = _bind$10;
      const _pred = _Some;
      if (cmp(_pred, moonbitlang$core$array$$ArrayView$at$27$(arr$2, _pivot)) === 0) {
        let i = _pivot;
        while (true) {
          if (i < len && cmp(_pred, moonbitlang$core$array$$ArrayView$at$27$(arr$2, i)) === 0) {
            i = i + 1 | 0;
            continue;
          } else {
            break;
        ...
        arr$2 = moonbitlang$core$array$$ArrayView$sub$46$inner$27$(arr$2, i, len);
        continue;
      }
    }
    const left = moonbitlang$core$array$$ArrayView$sub$46$inner$27$(arr$2, 0, _pivot);
    const right = moonbitlang$core$array$$ArrayView$sub$46$inner$27$(arr$2, _pivot + 1 | 0, len);
    if (left.len < right.len) {
      moonbitlang$core$array$$quick_sort_by$27$(left, cmp, pred$2, limit$2);
      pred$2 = moonbitlang$core$array$$ArrayView$at$27$(arr$2, _pivot);
      arr$2 = right;
    } else {
      moonbitlang$core$array$$quick_sort_by$27$(right, cmp, moonbitlang$core$array$$ArrayView$at$27$(arr$2, _pivot), limit$2);
      arr$2 = left;
    }
    continue;
  }
}
function moonbitlang$core$array$$Array$sort_by_key$50$(self, map) {
...
function moonbitlang$core$array$$Array$sort_by$27$(self, cmp) {
  moonbitlang$core$array$$quick_sort_by$27$({ buf: self, start: 0, len: self.length }, cmp, undefined, moonbitlang$core$array$$get_limit(self.length));
}
...
function moonbitlang$core$option$$Option$unwrap_or$20$(self, default_) {
  if (self.$tag === 0) {
    return default_;
  } else {
    const _Some = self;
...
function moonbitlang$core$set$$Set$add$0$(self, key) {
  moonbitlang$core$set$$Set$add_with_hash$0$(self, key, moonbitlang$core$builtin$$Hash$hash$35$(key));
}
...
function Milky2018$selene$backend$$CanvasBackend$new() {
  const canvas = moonbitlang$core$option$$Option$unwrap$39$(Yoorkin$rabbit$45$tea$dom$$IsEventTarget$to_html_canvas_element$59$(rami3l$js$45$ffi$js$$Nullable$unwrap$56$(Yoorkin$rabbit$45$tea$dom$$Document$get_element_by_id(Yoorkin$rabbit$45$tea$dom$$document(), "canvas"))));
  const context = moonbitlang$core$option$$Option$unwrap$40$(rami3l$js$45$ffi$js$$Union5$to0$53$(Yoorkin$rabbit$45$tea$dom$$HTMLCanvasElement$get_context(canvas, "2d")));
...
function Milky2018$selene$backend$$register_mouse_events(mouse, mouse_movement) {
  ...
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$58$(Milky2018$selene$backend$$window, "mousemove", (event) => {
    const mouse_event = moonbitlang$core$option$$Option$unwrap$38$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_mouse_event$60$(event));
...
function Milky2018$selene$backend$$register_key_events(pressed_keys) {
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$58$(Milky2018$selene$backend$$window, "keyup", (event) => {
    const keyboard_event = moonbitlang$core$option$$Option$unwrap$37$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_keyboard_event$60$(event));
...
function moonbitlang$core$builtin$$Show$output$4$(_x_85, _x_86) {
  ...
  moonbitlang$core$builtin$$Logger$write_object$29$(_x_86, _x_85);
  _x_86.method_0(_x_86.self, ")");
}
function moonbitlang$core$builtin$$Hash$hash_combine$4$(_x_81, _x_82) {
  moonbitlang$core$builtin$$Hash$hash_combine$29$(_x_81, _x_82);
}
...
function Milky2018$selene$system$$App$add_system$46$inner(self, system, schedule, system_name) {
  ...
  if (system_name === undefined) {
    system_name$2 = `unnamed_system${moonbitlang$core$builtin$$Show$to_string$18$(self.systems.length)}`;
  } else {
...
function Milky2018$selene$system$$App$run(self) {
  ...
  moonbitlang$core$array$$Array$sort_by_key$50$(renders, (system) => -system._1 | 0);
  ...
  while (true) {
    ...
    if (_p$4 < _p$3) {
      ...
      if (Milky2018$selene$system$$Entity$is_alive(_p$5._0)) {
        moonbitlang$core$array$$Array$push$27$(_p$2, _p$5);
      }
      _tmp = _p$4 + 1 | 0;
      continue;
    } else {
...
function Milky2018$selene$sprite$$frames_from_atlas$46$inner(sprite_path, frame_count, width, height, offset, space_x) {
  ...
  while (true) {
    ...
    if (i < frame_count) {
      ...
      moonbitlang$core$array$$Array$push$32$(frames, { sprite_path: sprite_path, size: { _0: width, _1: height }, offset: Milky2018$selene$math$$Vec2D$update(offset, 0, x) });
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  _L: {
    ...
    if (_bind$8 === undefined) {
      ...
      if (_x$2.$tag === 1) {
        ...
        const rate$2 = moonbitlang$core$option$$Option$unwrap_or$20$(rate, animation.fps);
...
function Milky2018$selene$collision$$add_collision_info(entity, target, direction) {
  ...
  if (_bind$8.$tag === 0) {
    moonbitlang$core$builtin$$Map$set$8$(Milky2018$selene$collision$$collision_infos, entity, moonbitlang$core$array$$Array$new$46$inner$48$(0));
  }
  moonbitlang$core$array$$Array$push$48$(moonbitlang$core$option$$Option$unwrap$41$(moonbitlang$core$builtin$$Map$get$8$(Milky2018$selene$collision$$collision_infos, entity)), { entity: target, direction: direction });
}
...
function Milky2018$selene$collision$$CollisionMask$contains(self, layer) {
  return moonbitlang$core$array$$Array$contains$49$(self, layer);
}
...
function Milky2018$selene$collision$$get_collision_infos(entity) {
  return moonbitlang$core$option$$Option$unwrap_or_default$41$(moonbitlang$core$builtin$$Map$get$8$(Milky2018$selene$collision$$collision_infos, entity));
}
...
function moonbitlang$core$builtin$$Eq$equal$21$(_x_81, _x_82) {
  switch (_x_81) {
    case 0: {
      if (_x_82 === 0) {
        return true;
...
function lnkfish$$create_fish(center) {
  ...
  moonbitlang$core$builtin$$Map$set$17$(lnkfish$$initial_offsets, white_fish_collider, { _0: -77.5, _1: -77.5 });
  ...
  moonbitlang$core$builtin$$Map$set$9$(Milky2018$selene$collision$$colliders, white_fish_collider, Milky2018$selene$collision$$Collider$new([lnkfish$$black_obstacle_layer]));
  ...
  moonbitlang$core$builtin$$Map$set$17$(lnkfish$$initial_offsets, black_fish_collider, { _0: 77.5, _1: 77.5 });
  ...
  moonbitlang$core$builtin$$Map$set$9$(Milky2018$selene$collision$$colliders, black_fish_collider, Milky2018$selene$collision$$Collider$new([lnkfish$$white_obstacle_layer]));
  moonbitlang$core$array$$Array$push$4$(lnkfish$$collider_entities.val, black_fish_collider);
}
function lnkfish$$create_black_obstacle(pos) {
  const entity = Milky2018$selene$system$$Entity$new();
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, entity, Milky2018$selene$sprite$$Sprite$from_picture(lnkfish$$black_obstacle_picture, 5, undefined));
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, entity, pos);
  moonbitlang$core$builtin$$Map$set$2$(Milky2018$selene$collision$$shapes, entity, new $64$Milky2018$47$selene$47$collision$46$CollisionShape$Rect({ _0: 195, _1: 40 }, { _0: 22.5, _1: 25 }));
  moonbitlang$core$builtin$$Map$set$10$(Milky2018$selene$collision$$collision_layers, entity, lnkfish$$black_obstacle_layer);
  moonbitlang$core$builtin$$Map$set$9$(Milky2018$selene$collision$$colliders, entity, Milky2018$selene$collision$$Collider$new([lnkfish$$white_fish_layer]));
  moonbitlang$core$builtin$$Map$set$23$(lnkfish$$obstacles, entity, { obstacle_type: 0 });
  return entity;
}
function lnkfish$$create_white_obstacle(pos) {
  const entity = Milky2018$selene$system$$Entity$new();
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, entity, Milky2018$selene$sprite$$Sprite$from_picture(lnkfish$$white_obstacle_picture, 5, undefined));
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, entity, pos);
  moonbitlang$core$builtin$$Map$set$2$(Milky2018$selene$collision$$shapes, entity, new $64$Milky2018$47$selene$47$collision$46$CollisionShape$Rect({ _0: 85, _1: 90 }, { _0: 37.5, _1: 35 }));
  moonbitlang$core$builtin$$Map$set$10$(Milky2018$selene$collision$$collision_layers, entity, lnkfish$$white_obstacle_layer);
  moonbitlang$core$builtin$$Map$set$9$(Milky2018$selene$collision$$colliders, entity, Milky2018$selene$collision$$Collider$new([lnkfish$$black_fish_layer]));
  moonbitlang$core$builtin$$Map$set$23$(lnkfish$$obstacles, entity, { obstacle_type: 1 });
  return entity;
}
function lnkfish$$reset_game() {
  ...
  const _arr$2 = lnkfish$$ui_entities.val;
  const _len$2 = _arr$2.length;
  let _tmp$2 = 0;
  while (true) {
    const _i = _tmp$2;
...
function lnkfish$$handle_input(delta) {
  _L: {
    ...
    switch (_bind$8) {
      ...
      case 1: {
        const _p = lnkfish$$visual_entity.val;
        if (_p === undefined) {
          return undefined;
        }
        const rotation_amount = 120 * delta;
...
function lnkfish$$obstacle_system(delta) {
  if (moonbitlang$core$builtin$$op_notequal$21$(lnkfish$$game_state.val, 1)) {
    return undefined;
  }
  if (lnkfish$$level_current_index.val < lnkfish$$level_sequence.length) {
    lnkfish$$obstacle_spawn_timer.val = lnkfish$$obstacle_spawn_timer.val + delta;
    const current_spawn_info = moonbitlang$core$array$$Array$at$31$(lnkfish$$level_sequence, lnkfish$$level_current_index.val);
    if (lnkfish$$obstacle_spawn_timer.val > current_spawn_info.delay) {
      ...
      let entity;
      if (_bind$8 === 0) {
        entity = lnkfish$$create_black_obstacle(pos);
      } else {
        entity = lnkfish$$create_white_obstacle(pos);
      }
    ...
    if (!lnkfish$$game_won_timer_set.val) {
      ...
      Milky2018$selene$system$$timeout$46$inner(5, () => {
        if (moonbitlang$core$builtin$$Eq$equal$21$(lnkfish$$game_state.val, 1)) {
...
function lnkfish$$update_rotation(delta) {
  ...
  if (_bind$8 === undefined) {
    ...
    const visual_transform = moonbitlang$core$builtin$$Mul$mul$61$(moonbitlang$core$builtin$$Mul$mul$61$(moonbitlang$core$builtin$$Mul$mul$61$(translate_back, rotation), translate_to_center), base_scale);
    ...
    while (true) {
      ...
      if (_i < _len) {
        ...
        const _bind$9 = moonbitlang$core$builtin$$Map$get$17$(lnkfish$$initial_offsets, c_entity);
  ...
  while (true) {
    ...
    if (_i < _len) {
      ...
      if (!(collisions.length === 0)) {
        ...
        moonbitlang$core$builtin$$println$33$(`Collision detected with obstacle: ${moonbitlang$core$builtin$$Show$to_string$34$(entity)}!`);
        if (moonbitlang$core$builtin$$Map$contains$23$(lnkfish$$obstacles, entity)) {
          const _p = moonbitlang$core$builtin$$Map$get$23$(lnkfish$$obstacles, entity);
          let obstacle;
          if (_p === undefined) {
            obstacle = $panic();
          } else {
          ...
          let hit_picture;
          if (_bind$8 === 0) {
            hit_picture = lnkfish$$black_obstacle_hit_picture;
          } else {
            hit_picture = lnkfish$$white_obstacle_hit_picture;
          }
          moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, entity, Milky2018$selene$sprite$$Sprite$from_picture(hit_picture, 10, undefined));
        }
...
function lnkfish$$ui_system(_delta) {
  ...
  switch (_bind$8) {
    case 0: {
      text_content = "按下空格以开始      ";
      break;
    }
    case 2: {
      text_content = "按下空格以重试      ";
      break;
    }
    case 3: {
      text_content = "未完待续...按下空格回到起点        ";
      break;
    }
    default: {
      text_content = "";
  ...
  if (!(text_content === _p)) {
    ...
    const text_sprite = Milky2018$selene$sprite$$Sprite$from_text(Milky2018$selene$sprite$$Text$new$46$inner(text_content, "white", "40px Arial"), 100, undefined);
    ...
    moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, ui_text, { _0: 372.5 - estimated_width / 2, _1: 350 });
