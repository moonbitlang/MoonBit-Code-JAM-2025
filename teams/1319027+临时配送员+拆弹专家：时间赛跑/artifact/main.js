...
const nopublish$pixeladventure$$new_game_state$46$42$bind$124$374 = "new_game";
...
const _bind$16 = [];
const _bind$17 = Milky2018$selene$sprite$$Text$new$46$inner("Time: 60", "#c28d06ff", "20px ThaleahFat");
...
function moonbitlang$core$builtin$$Logger$write_char$22$(self, ch) {
  const _bind$24 = self;
  _bind$24.val = `${_bind$24.val}${String.fromCodePoint(ch)}`;
}
...
function moonbitlang$core$builtin$$Logger$write_substring$22$(self, str, start, len) {
  const _bind$24 = self;
  _bind$24.val = `${_bind$24.val}${moonbitlang$core$string$$String$substring$46$inner(str, start, start + len | 0)}`;
}
...
function moonbitlang$core$builtin$$Map$new$46$inner$16$(capacity) {
  ...
  const _bind$24 = capacity$2 - 1 | 0;
  const _bind$25 = (Math.imul(capacity$2, 13) | 0) / 16 | 0;
  const _bind$26 = $make_array_len_and_init(capacity$2, undefined);
  const _bind$27 = undefined;
  return { entries: _bind$26, size: 0, capacity: capacity$2, capacity_mask: _bind$24, grow_at: _bind$25, head: _bind$27, tail: -1 };
}
...
function moonbitlang$core$builtin$$Map$add_entry_to_tail$7$(self, idx, entry) {
  const _bind$24 = self.tail;
  if (_bind$24 === -1) {
    self.head = entry;
  } else {
    const _tmp$2283 = self.entries;
    $bound_check(_tmp$2283, _bind$24);
    const _p$4569 = _tmp$2283[_bind$24];
    let _tmp$2284;
...
function moonbitlang$core$builtin$$Map$push_away$7$(self, idx, entry) {
  ...
  while (true) {
    ...
    const _bind$24 = _tmp$2286[idx$2];
    if (_bind$24 === undefined) {
      entry$2.psl = psl;
...
function moonbitlang$core$builtin$$Map$set_with_hash$7$(self, key, value, hash) {
  ...
  while (true) {
    ...
    const _bind$25 = _tmp$2285[idx];
    if (_bind$25 === undefined) {
      _bind$24 = { _0: idx, _1: psl };
      break;
    } else {
  ...
  const _idx = _bind$24._0;
  const _psl = _bind$24._1;
  const _bind$25 = self.tail;
  const _bind$26 = undefined;
  const entry = { prev: _bind$25, next: _bind$26, psl: _psl, hash: hash, key: key, value: value };
  ...
  const _p$4569 = (yield_) => {
    ...
    while (true) {
      ...
      if (_param === undefined) {
        ...
        const _value = _x.value;
        const _next = _x.next;
        const _bind$24 = yield_(_key, _value);
        if (_bind$24 === 1) {
          _tmp$2283 = _next;
          continue;
        } else {
...
function moonbitlang$core$array$$Array$quick_sort_by$23$(arr, start, end, cmp, pred, limit) {
  ...
  while (true) {
    ...
    const _bind$24 = moonbitlang$core$array$$Array$choose_pivot_by$23$(arr, current_start, current_end, cmp);
    const _pivot_index = _bind$24._0;
    const _likely_sorted = _bind$24._1;
    if (was_partitioned && (balanced && _likely_sorted)) {
      if (moonbitlang$core$array$$Array$try_bubble_sort_by$23$(arr, current_start, current_end, cmp)) {
        return undefined;
      }
    }
    const _bind$25 = moonbitlang$core$array$$Array$partition_by$23$(arr, current_start, current_end, cmp, _pivot_index);
    const _actual_pivot_pos = _bind$25._0;
    const _partitioned = _bind$25._1;
...
function moonbitlang$core$array$$Array$quick_sort_by$25$(arr, start, end, cmp, pred, limit) {
  ...
  while (true) {
    ...
    const _bind$24 = moonbitlang$core$array$$Array$choose_pivot_by$25$(arr, current_start, current_end, cmp);
    const _pivot_index = _bind$24._0;
    const _likely_sorted = _bind$24._1;
    if (was_partitioned && (balanced && _likely_sorted)) {
    ...
    const _bind$25 = moonbitlang$core$array$$Array$partition_by$25$(arr, current_start, current_end, cmp, _pivot_index);
    const _actual_pivot_pos = _bind$25._0;
    const _partitioned = _bind$25._1;
    was_partitioned = _partitioned;
    const pivot_pos = _actual_pivot_pos - current_start | 0;
      ...
      if (_n !== moonbitlang$core$double$$infinity) {
        if (_n !== moonbitlang$core$double$$neg_infinity) {
          if (_n > 2147483647 || _n < -2147483648) {
            const _bind$24 = moonbitlang$core$json$$decode_error$20$(path, "Int::from_json: overflow");
            if (_bind$24.$tag === 1) {
              const _ok = _bind$24;
              _ok._0;
            } else {
...
function moonbitlang$core$json$$FromJson$from_json$49$(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    const _bind$24 = new $64$moonbitlang$47$core$47$json$46$JsonPath$Index(path, 0);
    if (_bind$24.$tag === 2) {
      const _Index = _bind$24;
      let _p$4569;
      _L: {
        let _p$4570;
        _L$2: {
          ...
          while (true) {
            ...
            if (_p$4573 < _p$4572) {
              ...
              _Index._1 = _p$4573;
              const _bind$25 = moonbitlang$core$json$$FromJson$from_json$50$(_p$4574, _Index);
              let _tmp$2284;
              if (_bind$25.$tag === 1) {
                const _ok = _bind$25;
                _tmp$2284 = _ok._0;
        ...
        _L$2: {
          ...
          while (true) {
            ...
            if (_p$4573 < _p$4572) {
              const _p$4574 = _a[_p$4573];
              _Index._1 = _p$4573;
              const _bind$25 = moonbitlang$core$json$$FromJson$from_json$52$(_p$4574, _Index);
              let _tmp$2284;
              if (_bind$25.$tag === 1) {
                const _ok = _bind$25;
                _tmp$2284 = _ok._0;
...
function moonbitlang$core$set$$Set$add_with_hash$0$(self, key, hash) {
  ...
  const _bind$25 = self.tail;
  const _bind$26 = undefined;
  const entry = { prev: _bind$25, next: _bind$26, psl: _psl, hash: hash, key: key };
...
function Milky2018$selene$inputs$$advanced_key_system(_delta) {
  ...
  const _bind$24 = moonbitlang$core$set$$Set$iter$0$(moonbitlang$core$set$$Set$difference$0$(Milky2018$selene$inputs$$pressed_keys, Milky2018$selene$inputs$$last_pressed_keys));
  _bind$24((code) => {
  ...
  const _bind$25 = moonbitlang$core$set$$Set$iter$0$(moonbitlang$core$set$$Set$union$0$(moonbitlang$core$set$$Set$difference$0$(Milky2018$selene$inputs$$all_codes, Milky2018$selene$inputs$$pressed_keys), Milky2018$selene$inputs$$last_pressed_keys));
  _bind$25((code) => {
  ...
  const _bind$26 = moonbitlang$core$set$$Set$iter$0$(Milky2018$selene$inputs$$pressed_keys);
  _bind$26((code) => {
...
function Milky2018$selene$backend$$CanvasBackend$new() {
  ...
  const _bind$24 = { _0: 0, _1: 0 };
  const _bind$25 = moonbitlang$core$ref$$Ref$new$54$(undefined);
  return { canvas: canvas, context: context, viewport_size: _bind$24, zoom: 1, time_scale: 1, mouse_movement: _bind$25 };
}
function Milky2018$selene$backend$$register_mouse_events(mouse, mouse_movement) {
  ...
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$61$(Milky2018$selene$backend$$window, "mousedown", (event) => {
    const mouse_event = moonbitlang$core$option$$Option$unwrap$32$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_mouse_event$63$(event));
    const _bind$24 = Yoorkin$rabbit$45$tea$dom$$IsMouseEvent$get_button$60$(mouse_event);
    switch (_bind$24) {
      case 0: {
...
function Milky2018$selene$backend$$get_image_element(png) {
  const _bind$24 = moonbitlang$core$builtin$$Map$get$13$(Milky2018$selene$backend$$element_cache, png);
  if (_bind$24.$tag === 1) {
    const _Some = _bind$24;
...
function Milky2018$selene$backend$$initialize(startup, render_loop, game_loop, canvas_width, canvas_height, fps, image_smooth, zoom) {
  ...
  Milky2018$selene$backend$$schedule_with_fixed_interval(1000 / $f64_convert_i32_u(fps), (delta) => {
    ...
    const _bind$24 = Milky2018$selene$backend$$canvas_backend.mouse_movement.val;
    if (_bind$24 === undefined) {
      return;
    } else {
      const _Some = _bind$24;
...
function Milky2018$selene$backend$$get_audio(path) {
  const _bind$24 = moonbitlang$core$builtin$$Map$get$19$(Milky2018$selene$backend$$audio_cache, path);
  if (_bind$24.$tag === 1) {
    const _Some = _bind$24;
...
function Milky2018$selene$system$$deferred_event_system(_delta) {
  while (true) {
    const _bind$24 = moonbitlang$core$array$$Array$pop$11$(Milky2018$selene$system$$deferred_events);
    if (_bind$24 === undefined) {
      return;
    } else {
      const _Some = _bind$24;
...
function Milky2018$selene$camera$$camera_system(_delta) {
  const _bind$24 = Milky2018$selene$camera$$camera.attached_entity;
  if (_bind$24 === undefined) {
    return;
  } else {
    const _Some = _bind$24;
    const _e = _Some;
    const _bind$25 = moonbitlang$core$builtin$$Map$get$1$(Milky2018$selene$position$$positions, _e);
    if (_bind$25 === undefined) {
      return;
    } else {
      ...
      const _bind$26 = Milky2018$selene$camera$$camera.limit_top;
      if (_bind$26.$tag === 1) {
        const _Some$3 = _bind$26;
      ...
      const _bind$27 = Milky2018$selene$camera$$camera.limit_bottom;
      if (_bind$27.$tag === 1) {
        const _Some$3 = _bind$27;
      ...
      const _bind$28 = Milky2018$selene$camera$$camera.limit_left;
      if (_bind$28.$tag === 1) {
        const _Some$3 = _bind$28;
      ...
      const _bind$29 = Milky2018$selene$camera$$camera.limit_right;
      if (_bind$29.$tag === 1) {
        const _Some$3 = _bind$29;
...
function Milky2018$selene$sprite$$Sprite$from_animation$46$inner(animation, zindex, offset) {
  const _bind$24 = new $64$Milky2018$47$selene$47$sprite$46$SpriteType$Animation(animation, 0);
  return { sprite_type: _bind$24, zindex: zindex, visible: true, offset: offset };
}
...
function Milky2018$selene$sprite$$Sprite$from_picture$46$inner(picture, zindex, offset) {
  const _bind$24 = new $64$Milky2018$47$selene$47$sprite$46$SpriteType$Picture(picture);
  return { sprite_type: _bind$24, zindex: zindex, visible: true, offset: offset };
}
...
function Milky2018$selene$sprite$$Sprite$from_text$46$inner(text, zindex, offset) {
  const _bind$24 = new $64$Milky2018$47$selene$47$sprite$46$SpriteType$Text(text);
  return { sprite_type: _bind$24, zindex: zindex, visible: true, offset: offset };
}
...
function Milky2018$selene$sprite$$Sprite$from_color_rect$46$inner(color_rect, zindex, offset) {
  const _bind$24 = new $64$Milky2018$47$selene$47$sprite$46$SpriteType$ColorRect(color_rect);
  return { sprite_type: _bind$24, zindex: zindex, visible: true, offset: offset };
}
  ...
  moonbitlang$core$array$$Array$sort_by$25$(sprites, (sprite1, sprite2) => {
    if (sprite1._1.zindex < sprite2._1.zindex) {
      ...
      if (sprite1._1.zindex > sprite2._1.zindex) {
        ...
        const _bind$24 = moonbitlang$core$builtin$$Map$get$1$(Milky2018$selene$position$$positions, sprite1._0);
        if (_bind$24 === undefined) {
          return 0;
        } else {
          const _Some = _bind$24;
          const _pos1 = _Some;
          const _bind$25 = moonbitlang$core$builtin$$Map$get$1$(Milky2018$selene$position$$positions, sprite2._0);
          if (_bind$25 === undefined) {
            return 0;
          } else {
            const _Some$2 = _bind$25;
  ...
  while (true) {
    ...
    if (_i < _len) {
      _L: {
        ...
        const _bind$24 = moonbitlang$core$builtin$$Map$get$1$(Milky2018$selene$position$$positions, e);
        if (_bind$24 === undefined) {
          break _L;
        } else {
          const _Some = _bind$24;
          const _pos = _Some;
          const _bind$25 = moonbitlang$core$builtin$$Map$get$5$(Milky2018$selene$ui$$uis, e);
          let pos;
          if (_bind$25 === -1) {
          ...
          const _bind$26 = sprite$2.sprite_type;
          switch (_bind$26.$tag) {
            case 0: {
              const _Picture = _bind$26;
...
function Milky2018$selene$sprite$$play_animation$46$inner(entity, animation, from_start, loop_, rate, transform) {
  _L: {
    const _bind$24 = moonbitlang$core$builtin$$Map$get$14$(Milky2018$selene$sprite$$sprites, entity);
    if (_bind$24 === undefined) {
      break _L;
    } else {
      const _Some = _bind$24;
...
function Milky2018$selene$collision$$QuadTree$new(position, size, depth) {
  const _bind$24 = moonbitlang$core$set$$Set$new$46$inner$3$(8);
  const _bind$25 = [];
  const _bind$26 = { position: position, size: size };
  return { position: position, size: size, children: _bind$25, depth: depth, bounding_box: _bind$26, entities: _bind$24 };
}
...
function Milky2018$selene$collision$$quadtree_query(area) {
  ...
  while (true) {
    const _bind$24 = trees.val;
    if (_bind$24.$tag === 1) {
      const _More = _bind$24;
      const _hd = _More._0;
      ...
      const _bind$25 = _hd.children;
      if (_bind$25.length === 0) {
...
function Milky2018$selene$collision$$quadtree_clear_system(_delta) {
  ...
  const _bind$24 = moonbitlang$core$builtin$$Map$iter2$2$(Milky2018$selene$collision$$shapes);
  _bind$24((e, shape) => {
    if (Milky2018$selene$system$$Entity$is_alive(e)) {
      const _bind$25 = moonbitlang$core$builtin$$Map$get$5$(Milky2018$selene$ui$$uis, e);
      if (_bind$25 === -1) {
        const _bind$26 = moonbitlang$core$builtin$$Map$get$1$(Milky2018$selene$position$$positions, e);
        if (_bind$26 === undefined) {
          return 1;
        } else {
          const _Some = _bind$26;
          ...
          const _bind$27 = { _0: _position._0 + _offset._0, _1: _position._1 + _offset._1 };
          const _bind$28 = { _0: _width, _1: _height };
          const box = { position: _bind$27, size: _bind$28 };
          moonbitlang$core$array$$Array$push$41$(boxes, { _0: e, _1: box });
          const _p$4569 = left_limit.val;
          const _p$4570 = Milky2018$selene$math$$Vec2D$op_get(_bind$27, 0);
          left_limit.val = _p$4569 > _p$4570 ? _p$4570 : _p$4569;
          const _p$4571 = right_limit.val;
          const _p$4572 = Milky2018$selene$math$$Vec2D$op_get(_bind$27, 0) + Milky2018$selene$math$$Vec2D$op_get(_bind$28, 0);
          right_limit.val = _p$4571 > _p$4572 ? _p$4571 : _p$4572;
          const _p$4573 = top_limit.val;
          const _p$4574 = Milky2018$selene$math$$Vec2D$op_get(_bind$27, 1);
          top_limit.val = _p$4573 > _p$4574 ? _p$4574 : _p$4573;
          const _p$4575 = bottom_limit.val;
          const _p$4576 = Milky2018$selene$math$$Vec2D$op_get(_bind$27, 1) + Milky2018$selene$math$$Vec2D$op_get(_bind$28, 1);
...
function Milky2018$selene$collision$$pickable_click_system(_delta) {
  const zoom = Milky2018$selene$backend$$canvas_backend.zoom;
  const _bind$24 = { _0: 1, _1: 1 };
  const _p$4569 = Milky2018$selene$inputs$$mouse.pos;
  const _p$4570 = { _0: 1 / zoom, _1: 1 / zoom };
  const _bind$25 = { _0: _p$4569._0 * _p$4570._0, _1: _p$4569._1 * _p$4570._1 };
  const box = { position: _bind$25, size: _bind$24 };
  let _foreach_result = $64$moonbitlang$47$core$47$builtin$46$ForeachResult$Continue$16$;
  const _bind$26 = moonbitlang$core$builtin$$Map$iter2$5$(Milky2018$selene$ui$$uis);
  _bind$26((e, _ui) => {
    if (Milky2018$selene$system$$Entity$is_alive(e)) {
      const _bind$27 = moonbitlang$core$builtin$$Map$get$4$(Milky2018$selene$collision$$pickables, e);
      if (_bind$27 === undefined) {
        ...
        if (_bind$28 === undefined) {
          ...
          if (_bind$29 === undefined) {
            ...
            const _height = _x._1;
            const _offset = _Rect._1;
            const _bind$30 = { _0: _width, _1: _height };
            const _bind$31 = { _0: _position._0 + _offset._0, _1: _position._1 + _offset._1 };
            const area_box = { position: _bind$31, size: _bind$30 };
  ...
  const _bind$27 = moonbitlang$core$set$$Set$iter$3$(entities);
  _bind$27((e) => {
    if (Milky2018$selene$system$$Entity$is_alive(e)) {
      const _bind$28 = moonbitlang$core$builtin$$Map$get$4$(Milky2018$selene$collision$$pickables, e);
      if (_bind$28 === undefined) {
        return 1;
      } else {
        const _Some = _bind$28;
        const _pick = _Some;
        const _bind$29 = moonbitlang$core$builtin$$Map$get$1$(Milky2018$selene$position$$positions, e);
        if (_bind$29 === undefined) {
          $panic();
        } else {
          const _Some$2 = _bind$29;
          const _position = _Some$2;
          const _bind$30 = moonbitlang$core$builtin$$Map$get$2$(Milky2018$selene$collision$$shapes, e);
          if (_bind$30 === undefined) {
            ...
            const _bind$32 = { _0: _position._0 + _offset._0, _1: _position._1 + _offset._1 };
            const area_box = { position: _bind$32, size: _bind$31 };
...
function Milky2018$selene$collision$$add_collision_info(entity, target, direction) {
  const _bind$24 = moonbitlang$core$builtin$$Map$get$8$(Milky2018$selene$collision$$collision_infos, entity);
  if (_bind$24.$tag === 0) {
...
function Milky2018$selene$collision$$move_axis(entity, object, velocity, axis, mask) {
  ...
  const _bind$24 = moonbitlang$core$set$$Set$iter$3$(entities);
  _bind$24((e) => {
    if (Milky2018$selene$system$$Entity$is_alive(e)) {
      if (moonbitlang$core$builtin$$op_notequal$3$(e, entity)) {
        const _bind$25 = moonbitlang$core$builtin$$Map$get$2$(Milky2018$selene$collision$$shapes, e);
        if (_bind$25 === undefined) {
          return 1;
        } else {
          const _Some = _bind$25;
          ...
          if (_bind$26 === undefined) {
            ...
            const _Some$2 = _bind$26;
            const _pos = _Some$2;
            const _bind$27 = moonbitlang$core$builtin$$Map$get$10$(Milky2018$selene$collision$$collision_layers, e);
            if (_bind$27 === undefined) {
              return 1;
            } else {
              const _Some$3 = _bind$27;
              ...
              if (Milky2018$selene$collision$$CollisionMask$contains(mask, _collision_layer)) {
                const _bind$28 = { _0: _width, _1: _height };
                const _bind$29 = { _0: _pos._0 + _offset._0, _1: _pos._1 + _offset._1 };
                const collision_box = { position: _bind$29, size: _bind$28 };
                ...
                if (Milky2018$selene$math$$Rect$intersects(ray_collision, collision_box)) {
                  ...
                  if (Milky2018$selene$math$$Vec2D$op_get(new_velocity.val, axis) > 0) {
                    ...
                    const _p$4569 = Milky2018$selene$math$$Vec2D$op_get(_bind$29, axis) - Milky2018$selene$math$$Vec2D$op_get(object.size, axis);
                    ...
                    if (Milky2018$selene$math$$Vec2D$op_get(new_velocity.val, axis) < 0) {
                      const _tmp$2283 = new_pos.val;
                      const _p$4569 = Milky2018$selene$math$$Vec2D$op_get(_bind$29, axis) + Milky2018$selene$math$$Vec2D$op_get(_bind$28, axis);
                      const _p$4570 = Milky2018$selene$math$$Vec2D$op_get(object.position, axis);
...
function Milky2018$selene$collision$$move_with_collide(e, collider, velocity) {
  ...
  if (_bind$24 === undefined) {
    ...
    if (_bind$25 === undefined) {
      ...
      const _height = _x._1;
      const _offset = _Rect._1;
      const _bind$26 = { _0: _pos._0 + _offset._0, _1: _pos._1 + _offset._1 };
      const _bind$27 = { _0: _width, _1: _height };
      const box = { position: _bind$26, size: _bind$27 };
      const new_x = Milky2018$selene$collision$$move_axis(e, box, velocity, 0, collider.mask);
      const _bind$28 = new_x._0;
      const object_x = { position: _bind$28, size: _bind$27 };
...
function Milky2018$selene$collision$$move_system(delta) {
  ...
  let _foreach_result = $64$moonbitlang$47$core$47$builtin$46$ForeachResult$Continue$16$;
  const _bind$24 = moonbitlang$core$builtin$$Map$iter2$7$(Milky2018$selene$velocity$$velocities);
  _bind$24((e, vel) => {
    if (Milky2018$selene$system$$Entity$is_alive(e)) {
      _L: {
        _L$2: {
          const _bind$25 = moonbitlang$core$builtin$$Map$get$9$(Milky2018$selene$collision$$colliders, e);
          if (_bind$25 === undefined) {
            break _L$2;
          } else {
            const _Some = _bind$25;
...
function Milky2018$selene$collision$$area_collide_system(_delta) {
  ...
  const _bind$24 = Milky2018$selene$system$$iter_entities();
  _bind$24((e) => {
    const _bind$25 = moonbitlang$core$builtin$$Map$get$12$(Milky2018$selene$collision$$areas, e);
    if (_bind$25 === undefined) {
      return 1;
    } else {
      const _Some = _bind$25;
      ...
      if (_bind$26 === undefined) {
        ...
        const _Some$2 = _bind$26;
        const _position = _Some$2;
        const _bind$27 = moonbitlang$core$builtin$$Map$get$2$(Milky2018$selene$collision$$shapes, e);
        if (_bind$27 === undefined) {
          return 1;
        } else {
          const _Some$3 = _bind$27;
          ...
          const _offset = _Rect._1;
          const _bind$28 = { _0: _width, _1: _height };
          const _bind$29 = { _0: _position._0 + _offset._0, _1: _position._1 + _offset._1 };
          const box = { position: _bind$29, size: _bind$28 };
          const new_contains = moonbitlang$core$set$$Set$new$46$inner$3$(8);
          const entities = Milky2018$selene$collision$$quadtree_query(box);
          let _foreach_result$2 = $64$moonbitlang$47$core$47$builtin$46$ForeachResult$Continue$16$;
          const _bind$30 = moonbitlang$core$set$$Set$iter$3$(entities);
          _bind$30((entity) => {
            if (Milky2018$selene$system$$Entity$is_alive(entity)) {
              const _bind$31 = moonbitlang$core$builtin$$Map$get$10$(Milky2018$selene$collision$$collision_layers, entity);
              if (_bind$31 === undefined) {
                return 1;
              } else {
                const _Some$4 = _bind$31;
                const _other_layer = _Some$4;
                const _bind$32 = moonbitlang$core$builtin$$Map$get$2$(Milky2018$selene$collision$$shapes, entity);
                if (_bind$32 === undefined) {
                  return 1;
                } else {
                  const _Some$5 = _bind$32;
                  ...
                  const _bind$33 = moonbitlang$core$builtin$$Map$get$1$(Milky2018$selene$position$$positions, entity);
                  if (_bind$33 === undefined) {
                    $panic();
                  } else {
                    const _Some$6 = _bind$33;
                    const _other_position = _Some$6;
                    const _bind$34 = { _0: _other_width, _1: _other_height };
                    const _bind$35 = { _0: _other_position._0 + _other_offset._0, _1: _other_position._1 + _other_offset._1 };
                    const other_box = { position: _bind$35, size: _bind$34 };
          ...
          const _bind$31 = moonbitlang$core$set$$Set$iter$3$(_area.contains);
          _bind$31((entity) => {
...
function moonbitlang$core$json$$FromJson$from_json$50$(_x_61, _x_62) {
  ...
  if (_x_61.$tag === 6) {
    ...
    const _bind$24 = moonbitlang$core$builtin$$Map$get$18$(__map, "name");
    if (_bind$24 === undefined) {
    } else {
      const _Some = _bind$24;
      const __v = _Some;
      const _p$4569 = "name";
      const _bind$25 = moonbitlang$core$json$$FromJson$from_json$26$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_62, _p$4569));
      let _tmp$2283;
      if (_bind$25.$tag === 1) {
        const _ok = _bind$25;
        _tmp$2283 = _ok._0;
    ...
    const _bind$25 = moonbitlang$core$builtin$$Map$get$18$(__map, "tiles");
    if (_bind$25 === undefined) {
    } else {
      const _Some = _bind$25;
      const __v = _Some;
      const _p$4569 = "tiles";
      const _bind$26 = moonbitlang$core$json$$FromJson$from_json$51$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_62, _p$4569));
      let _tmp$2283;
      if (_bind$26.$tag === 1) {
        const _ok = _bind$26;
        _tmp$2283 = _ok._0;
    ...
    const _bind$26 = moonbitlang$core$builtin$$Map$get$18$(__map, "collider");
    if (_bind$26 === undefined) {
    } else {
      const _Some = _bind$26;
      const __v = _Some;
      const _p$4569 = "collider";
      const _bind$27 = moonbitlang$core$json$$FromJson$from_json$47$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_62, _p$4569));
      let _tmp$2283;
      if (_bind$27.$tag === 1) {
        const _ok = _bind$27;
        _tmp$2283 = _ok._0;
  ...
  const _bind$26 = _de_collider_63;
...
function moonbitlang$core$json$$FromJson$from_json$48$(_x_36, _x_37) {
  ...
  if (_x_36.$tag === 6) {
    const _Object = _x_36;
    const __map = _Object._0;
    const _bind$24 = moonbitlang$core$builtin$$Map$get$18$(__map, "tileSize");
    if (_bind$24 === undefined) {
    } else {
      const _Some = _bind$24;
      const __v = _Some;
      const _p$4569 = "tileSize";
      const _bind$25 = moonbitlang$core$json$$FromJson$from_json$17$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_37, _p$4569));
      let _tmp$2283;
      if (_bind$25.$tag === 1) {
        const _ok = _bind$25;
        _tmp$2283 = _ok._0;
    ...
    const _bind$25 = moonbitlang$core$builtin$$Map$get$18$(__map, "mapWidth");
    if (_bind$25 === undefined) {
    } else {
      const _Some = _bind$25;
      const __v = _Some;
      const _p$4569 = "mapWidth";
      const _bind$26 = moonbitlang$core$json$$FromJson$from_json$17$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_37, _p$4569));
      let _tmp$2283;
      if (_bind$26.$tag === 1) {
        const _ok = _bind$26;
        _tmp$2283 = _ok._0;
    ...
    const _bind$26 = moonbitlang$core$builtin$$Map$get$18$(__map, "mapHeight");
    if (_bind$26 === undefined) {
    } else {
      const _Some = _bind$26;
      const __v = _Some;
      const _p$4569 = "mapHeight";
      const _bind$27 = moonbitlang$core$json$$FromJson$from_json$17$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_37, _p$4569));
      let _tmp$2283;
      if (_bind$27.$tag === 1) {
        const _ok = _bind$27;
        _tmp$2283 = _ok._0;
    ...
    const _bind$27 = moonbitlang$core$builtin$$Map$get$18$(__map, "layers");
    if (_bind$27 === undefined) {
    } else {
      const _Some = _bind$27;
      const __v = _Some;
      const _p$4569 = "layers";
      const _bind$28 = moonbitlang$core$json$$FromJson$from_json$49$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_37, _p$4569));
      let _tmp$2283;
      if (_bind$28.$tag === 1) {
        const _ok = _bind$28;
        _tmp$2283 = _ok._0;
  ...
  const _bind$24 = _de_tile_size_41;
  ...
  const _bind$25 = _de_map_width_40;
  ...
  const _bind$26 = _de_map_height_39;
...
function moonbitlang$core$json$$FromJson$from_json$52$(_x_16, _x_17) {
  ...
  if (_x_16.$tag === 6) {
    const _Object = _x_16;
    const __map = _Object._0;
    const _bind$24 = moonbitlang$core$builtin$$Map$get$18$(__map, "id");
    if (_bind$24 === undefined) {
    } else {
      const _Some = _bind$24;
      const __v = _Some;
      const _p$4569 = "id";
      const _bind$25 = moonbitlang$core$json$$FromJson$from_json$26$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_17, _p$4569));
      let _tmp$2283;
      if (_bind$25.$tag === 1) {
        const _ok = _bind$25;
        _tmp$2283 = _ok._0;
    ...
    const _bind$25 = moonbitlang$core$builtin$$Map$get$18$(__map, "x");
    if (_bind$25 === undefined) {
    } else {
      const _Some = _bind$25;
      const __v = _Some;
      const _p$4569 = "x";
      const _bind$26 = moonbitlang$core$json$$FromJson$from_json$17$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_17, _p$4569));
      let _tmp$2283;
      if (_bind$26.$tag === 1) {
        const _ok = _bind$26;
        _tmp$2283 = _ok._0;
    ...
    const _bind$26 = moonbitlang$core$builtin$$Map$get$18$(__map, "y");
    if (_bind$26 === undefined) {
    } else {
      const _Some = _bind$26;
      const __v = _Some;
      const _p$4569 = "y";
      const _bind$27 = moonbitlang$core$json$$FromJson$from_json$17$(__v, new $64$moonbitlang$47$core$47$json$46$JsonPath$Key(_x_17, _p$4569));
      let _tmp$2283;
      if (_bind$27.$tag === 1) {
        const _ok = _bind$27;
        _tmp$2283 = _ok._0;
...
function Milky2018$selene$tilemap$$TileMap$from_json(json) {
  let _try_err;
  _L: {
    const _bind$24 = moonbitlang$core$json$$from_json$48$(json, undefined);
    if (_bind$24.$tag === 1) {
      const _ok = _bind$24;
      return _ok._0;
    } else {
...
const nopublish$pixeladventure$$add_background$46$constr$47$2779 = 3;
function nopublish$pixeladventure$$add_background(size) {
  const background = Milky2018$selene$system$$Entity$new();
  const background_sprite = Milky2018$selene$sprite$$Sprite$from_picture(Milky2018$selene$sprite$$Picture$new(size, "assets/Background/Brown.png", undefined, nopublish$pixeladventure$$add_background$46$constr$47$2779), 0, undefined);
...
function nopublish$pixeladventure$$add_block1(x, y, color) {
  const block_entity = Milky2018$selene$system$$Entity$new();
  const block_sprite = Milky2018$selene$sprite$$Sprite$from_color_rect(Milky2018$selene$sprite$$ColorRect$new({ _0: 10, _1: 20 }, color), 1, undefined);
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, block_entity, block_sprite);
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, block_entity, { _0: x, _1: y });
}
function nopublish$pixeladventure$$add_block2(x, y, color) {
  const block_entity = Milky2018$selene$system$$Entity$new();
  const block_sprite = Milky2018$selene$sprite$$Sprite$from_color_rect(Milky2018$selene$sprite$$ColorRect$new({ _0: 20, _1: 10 }, color), 1, undefined);
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, block_entity, block_sprite);
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, block_entity, { _0: x, _1: y });
}
function nopublish$pixeladventure$$add_block_back(x, y, color) {
  const block_entity = Milky2018$selene$system$$Entity$new();
  const block_sprite = Milky2018$selene$sprite$$Sprite$from_color_rect(Milky2018$selene$sprite$$ColorRect$new({ _0: 80, _1: 80 }, color), 0, undefined);
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, block_entity, block_sprite);
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, block_entity, { _0: x, _1: y });
}
...
function nopublish$pixeladventure$$add_color_to_line(pos, color, x, y) {
  const sprite = Milky2018$selene$sprite$$Sprite$from_color_rect(Milky2018$selene$sprite$$ColorRect$new({ _0: x, _1: y }, color), 2, undefined);
  const color_block = Milky2018$selene$system$$Entity$new();
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, color_block, sprite);
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, color_block, pos);
  moonbitlang$core$builtin$$Map$set$2$(Milky2018$selene$collision$$shapes, color_block, new $64$Milky2018$47$selene$47$collision$46$CollisionShape$Rect({ _0: x, _1: y }, { _0: 0, _1: 0 }));
  moonbitlang$core$builtin$$Map$set$10$(Milky2018$selene$collision$$collision_layers, color_block, nopublish$pixeladventure$$terrain_collision_layer);
}
const nopublish$pixeladventure$$generate_map$46$constr$47$2819 = new Option$Some$0$(0);
const nopublish$pixeladventure$$generate_map$46$constr$47$2820 = new Option$Some$0$(0);
function nopublish$pixeladventure$$generate_map() {
  ...
  Milky2018$selene$camera$$set_limits(nopublish$pixeladventure$$generate_map$46$constr$47$2819, new Option$Some$0$(world_height), nopublish$pixeladventure$$generate_map$46$constr$47$2820, new Option$Some$0$(world_width));
  nopublish$pixeladventure$$add_background({ _0: world_width, _1: world_height });
  nopublish$pixeladventure$$add_block_back(70, 70, "#05f390ff");
  nopublish$pixeladventure$$add_block_back(200, 70, "#d10303ff");
  nopublish$pixeladventure$$add_block_back(70, 200, "#e8dd08ff");
  nopublish$pixeladventure$$add_block_back(200, 200, "#e88708ff");
  nopublish$pixeladventure$$add_block1(100, 90, "#d10303ff");
  nopublish$pixeladventure$$add_block2(260, 90, "#e8dd08ff");
  nopublish$pixeladventure$$add_block2(100, 220, "#e88708ff");
  nopublish$pixeladventure$$add_block1(220, 220, "#05f390ff");
  nopublish$pixeladventure$$add_color_to_line({ _0: 109, _1: 100 }, "#d10303ff", 120, 2);
  nopublish$pixeladventure$$add_color_to_line({ _0: 240, _1: 94 }, "#e8dd08ff", 20, 2);
  nopublish$pixeladventure$$add_color_to_line({ _0: 240, _1: 94 }, "#e8dd08ff", 2, 75);
  nopublish$pixeladventure$$add_color_to_line({ _0: 100, _1: 169 }, "#e8dd08ff", 142, 2);
  nopublish$pixeladventure$$add_color_to_line({ _0: 100, _1: 169 }, "#e8dd08ff", 2, 40);
  nopublish$pixeladventure$$add_color_to_line({ _0: 120, _1: 224 }, "#e88708ff", 100, 2);
  nopublish$pixeladventure$$add_color_to_line({ _0: 138, _1: 138 }, "#05f390ff", 2, 50);
  nopublish$pixeladventure$$add_color_to_line({ _0: 138, _1: 188 }, "#05f390ff", 85, 2);
  nopublish$pixeladventure$$add_color_to_line({ _0: 223, _1: 188 }, "#05f390ff", 2, 35);
...
function nopublish$pixeladventure$$add_block1_select(x, y, color) {
  const block_entity = Milky2018$selene$system$$Entity$new();
  const block_sprite = Milky2018$selene$sprite$$Sprite$from_color_rect(Milky2018$selene$sprite$$ColorRect$new({ _0: 10, _1: 20 }, color), 2, undefined);
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, block_entity, block_sprite);
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, block_entity, { _0: x, _1: y });
}
function nopublish$pixeladventure$$add_block2_select(x, y, color) {
  const block_entity = Milky2018$selene$system$$Entity$new();
  const block_sprite = Milky2018$selene$sprite$$Sprite$from_color_rect(Milky2018$selene$sprite$$ColorRect$new({ _0: 20, _1: 10 }, color), 2, undefined);
  moonbitlang$core$builtin$$Map$set$14$(Milky2018$selene$sprite$$sprites, block_entity, block_sprite);
  moonbitlang$core$builtin$$Map$set$1$(Milky2018$selene$position$$positions, block_entity, { _0: x, _1: y });
}
function nopublish$pixeladventure$$update_block_display(_delta) {
  if (nopublish$pixeladventure$$new_game_state.timer === 0 && nopublish$pixeladventure$$new_game_state.timer1 !== 3) {
  ...
  if (nopublish$pixeladventure$$new_game_state.timer > 0) {
    if (Milky2018$selene$inputs$$is_just_pressed(0) && nopublish$pixeladventure$$new_game_state.mouse_load) {
      if (nopublish$pixeladventure$$new_game_state.timer1 === 2) {
        Milky2018$selene$audio$$play_audio$46$inner("sounds/jump.wav", 1, false);
        nopublish$pixeladventure$$add_block1_select(100, 90, "#110d0dff");
        nopublish$pixeladventure$$new_game_state.timer1 = 3;
      } else {
        nopublish$pixeladventure$$new_game_state.mouse_load = false;
        Milky2018$selene$audio$$play_audio$46$inner("sounds/explosion.wav", 1, false);
        nopublish$pixeladventure$$add_failed_box();
        nopublish$pixeladventure$$new_game_state.timer = 0;
      }
    }
    if (Milky2018$selene$inputs$$is_just_pressed(1) && nopublish$pixeladventure$$new_game_state.mouse_load) {
      if (nopublish$pixeladventure$$new_game_state.timer1 === 0) {
        Milky2018$selene$audio$$play_audio$46$inner("sounds/jump.wav", 1, false);
        nopublish$pixeladventure$$add_block2_select(260, 90, "#110d0dff");
        nopublish$pixeladventure$$new_game_state.timer1 = 1;
      } else {
        nopublish$pixeladventure$$new_game_state.mouse_load = false;
        Milky2018$selene$audio$$play_audio$46$inner("sounds/explosion.wav", 1, false);
        nopublish$pixeladventure$$add_failed_box();
    ...
    if (Milky2018$selene$inputs$$is_just_pressed(2) && nopublish$pixeladventure$$new_game_state.mouse_load) {
      if (nopublish$pixeladventure$$new_game_state.timer1 === 1) {
        Milky2018$selene$audio$$play_audio$46$inner("sounds/jump.wav", 1, false);
        nopublish$pixeladventure$$add_block2_select(100, 220, "#110d0dff");
        nopublish$pixeladventure$$new_game_state.timer1 = 2;
      } else {
        nopublish$pixeladventure$$new_game_state.mouse_load = false;
        Milky2018$selene$audio$$play_audio$46$inner("sounds/explosion.wav", 1, false);
        nopublish$pixeladventure$$add_failed_box();
    ...
    if (Milky2018$selene$inputs$$is_just_pressed(3) && nopublish$pixeladventure$$new_game_state.mouse_load) {
      if (nopublish$pixeladventure$$new_game_state.timer1 === 3) {
        Milky2018$selene$audio$$play_audio$46$inner("sounds/jump.wav", 1, false);
        nopublish$pixeladventure$$add_block1_select(220, 220, "#110d0dff");
...
function nopublish$pixeladventure$$bird_ai_system(_discard_) {
  if (nopublish$pixeladventure$$new_game_state.gameStarted && nopublish$pixeladventure$$new_game_state.gameReStarted) {
    let _foreach_result = $64$moonbitlang$47$core$47$builtin$46$ForeachResult$Continue$16$;
    const _bind$24 = moonbitlang$core$builtin$$Map$iter2$16$(nopublish$pixeladventure$$birds);
    _bind$24((e, bird) => {
      nopublish$pixeladventure$$add_timer();
      Milky2018$selene$audio$$play_audio$46$inner("sounds/game.wav", 1, false);
      if (Milky2018$selene$system$$Entity$is_alive(e)) {
        const _bind$25 = moonbitlang$core$builtin$$Map$get$7$(Milky2018$selene$velocity$$velocities, e);
        if (_bind$25 === undefined) {
          $panic();
        } else {
          ...
          if (hit_wall) {
            ...
            if (nopublish$pixeladventure$$new_game_state.timer1 === 3 || nopublish$pixeladventure$$new_game_state.timer === 0) {
              Milky2018$selene$system$$Entity$destroy(e);
            }
            const _bind$26 = bird.direction;
            let _tmp$2283;
