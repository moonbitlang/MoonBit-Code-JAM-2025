...
function moonbitlang$core$array$$bubble_sort_by$20$(arr, cmp) {
  ...
  while (true) {
    ...
    if (i < _end940) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j > 0 && cmp(moonbitlang$core$array$$ArrayView$op_get$20$(arr, j - 1 | 0), moonbitlang$core$array$$ArrayView$op_get$20$(arr, j)) > 0) {
...
function moonbitlang$core$array$$bubble_sort_by$22$(arr, cmp) {
  ...
  while (true) {
    ...
    if (i < _end940) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j > 0 && cmp(moonbitlang$core$array$$ArrayView$op_get$22$(arr, j - 1 | 0), moonbitlang$core$array$$ArrayView$op_get$22$(arr, j)) > 0) {
...
function moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$70(_env, a, b) {
  ...
  const cmp = _env._1;
  const swaps = _env._0;
  if (cmp(moonbitlang$core$array$$ArrayView$op_get$20$(arr, a), moonbitlang$core$array$$ArrayView$op_get$20$(arr, b)) > 0) {
...
function moonbitlang$core$array$$choose_pivot_by$46$sort_2$47$90(_env, a, b) {
  ...
  const cmp = _env._1;
  const swaps = _env._0;
  if (cmp(moonbitlang$core$array$$ArrayView$op_get$22$(arr, a), moonbitlang$core$array$$ArrayView$op_get$22$(arr, b)) > 0) {
...
function moonbitlang$core$array$$sift_down_by$20$(arr, index, cmp) {
  ...
  while (true) {
    if (child < len) {
      if ((child + 1 | 0) < len && cmp(moonbitlang$core$array$$ArrayView$op_get$20$(arr, child), moonbitlang$core$array$$ArrayView$op_get$20$(arr, child + 1 | 0)) < 0) {
        child = child + 1 | 0;
      }
      if (cmp(moonbitlang$core$array$$ArrayView$op_get$20$(arr, index$2), moonbitlang$core$array$$ArrayView$op_get$20$(arr, child)) >= 0) {
        return undefined;
      }
...
function moonbitlang$core$array$$sift_down_by$22$(arr, index, cmp) {
  ...
  while (true) {
    if (child < len) {
      if ((child + 1 | 0) < len && cmp(moonbitlang$core$array$$ArrayView$op_get$22$(arr, child), moonbitlang$core$array$$ArrayView$op_get$22$(arr, child + 1 | 0)) < 0) {
        child = child + 1 | 0;
      }
      if (cmp(moonbitlang$core$array$$ArrayView$op_get$22$(arr, index$2), moonbitlang$core$array$$ArrayView$op_get$22$(arr, child)) >= 0) {
        return undefined;
      }
...
function moonbitlang$core$array$$heap_sort_by$20$(arr, cmp) {
  ...
  while (true) {
    ...
    if (i > 0) {
      ...
      moonbitlang$core$array$$sift_down_by$20$(moonbitlang$core$array$$ArrayView$op_as_view$46$inner$20$(arr, 0, i), 0, cmp);
      _tmp$2 = i - 1 | 0;
      continue;
    } else {
      return;
...
function moonbitlang$core$array$$heap_sort_by$22$(arr, cmp) {
  ...
  while (true) {
    ...
    if (i > 0) {
      ...
      moonbitlang$core$array$$sift_down_by$22$(moonbitlang$core$array$$ArrayView$op_as_view$46$inner$22$(arr, 0, i), 0, cmp);
      _tmp$2 = i - 1 | 0;
      continue;
    } else {
      return;
...
function moonbitlang$core$array$$partition_by$20$(arr, cmp, pivot_index) {
  ...
  const pivot = moonbitlang$core$array$$ArrayView$op_get$20$(arr, arr.len - 1 | 0);
  let i = 0;
  let partitioned = true;
  const _end933 = arr.len - 1 | 0;
  let _tmp = 0;
  while (true) {
    const j = _tmp;
    if (j < _end933) {
      if (cmp(moonbitlang$core$array$$ArrayView$op_get$20$(arr, j), pivot) < 0) {
        if (i !== j) {
...
function moonbitlang$core$array$$partition_by$22$(arr, cmp, pivot_index) {
  ...
  const pivot = moonbitlang$core$array$$ArrayView$op_get$22$(arr, arr.len - 1 | 0);
  let i = 0;
  let partitioned = true;
  const _end933 = arr.len - 1 | 0;
  let _tmp = 0;
  while (true) {
    const j = _tmp;
    if (j < _end933) {
      if (cmp(moonbitlang$core$array$$ArrayView$op_get$22$(arr, j), pivot) < 0) {
        if (i !== j) {
...
function moonbitlang$core$array$$quick_sort_by$20$(arr, cmp, pred, limit) {
  ...
  while (true) {
    ...
    if (_bind$10 === undefined) {
      ...
      const _pred = _Some;
      if (cmp(_pred, moonbitlang$core$array$$ArrayView$op_get$20$(arr$2, _pivot)) === 0) {
        let i = _pivot;
        while (true) {
          if (i < len && cmp(_pred, moonbitlang$core$array$$ArrayView$op_get$20$(arr$2, i)) === 0) {
            i = i + 1 | 0;
            continue;
          } else {
            break;
        ...
        arr$2 = moonbitlang$core$array$$ArrayView$op_as_view$46$inner$20$(arr$2, i, len);
        continue;
      }
    }
    const left = moonbitlang$core$array$$ArrayView$op_as_view$46$inner$20$(arr$2, 0, _pivot);
    const right = moonbitlang$core$array$$ArrayView$op_as_view$46$inner$20$(arr$2, _pivot + 1 | 0, len);
    if (left.len < right.len) {
      ...
      moonbitlang$core$array$$quick_sort_by$20$(right, cmp, moonbitlang$core$array$$ArrayView$op_get$20$(arr$2, _pivot), limit$2);
      arr$2 = left;
    }
    continue;
  }
...
function moonbitlang$core$array$$quick_sort_by$22$(arr, cmp, pred, limit) {
  ...
  while (true) {
    ...
    if (_bind$10 === undefined) {
      ...
      const _Some = _bind$10;
      const _pred = _Some;
      if (cmp(_pred, moonbitlang$core$array$$ArrayView$op_get$22$(arr$2, _pivot)) === 0) {
        let i = _pivot;
        while (true) {
          if (i < len && cmp(_pred, moonbitlang$core$array$$ArrayView$op_get$22$(arr$2, i)) === 0) {
            i = i + 1 | 0;
            continue;
          } else {
            break;
        ...
        arr$2 = moonbitlang$core$array$$ArrayView$op_as_view$46$inner$22$(arr$2, i, len);
        continue;
      }
    }
    const left = moonbitlang$core$array$$ArrayView$op_as_view$46$inner$22$(arr$2, 0, _pivot);
    const right = moonbitlang$core$array$$ArrayView$op_as_view$46$inner$22$(arr$2, _pivot + 1 | 0, len);
    if (left.len < right.len) {
      moonbitlang$core$array$$quick_sort_by$22$(left, cmp, pred$2, limit$2);
      pred$2 = moonbitlang$core$array$$ArrayView$op_get$22$(arr$2, _pivot);
      arr$2 = right;
    } else {
      moonbitlang$core$array$$quick_sort_by$22$(right, cmp, moonbitlang$core$array$$ArrayView$op_get$22$(arr$2, _pivot), limit$2);
      arr$2 = left;
    }
    continue;
  }
...
function moonbitlang$core$array$$Array$sort_by_key$30$(self, map) {
  moonbitlang$core$array$$quick_sort_by$22$({ buf: self, start: 0, len: self.length }, (a, b) => $compare_int(map(a), map(b)), undefined, moonbitlang$core$array$$get_limit(self.length));
}
...
function moonbitlang$core$set$$Set$add_with_hash$0$(self, key, hash) {
  ...
  while (true) {
    ...
    if (_bind$9 === undefined) {
      ...
      const _Some = _bind$9;
      const _curr_entry = _Some;
      if (_curr_entry.hash === hash && moonbitlang$core$builtin$$Eq$op_equal$0$(_curr_entry.key, key)) {
        return undefined;
      }
      if (psl > _curr_entry.psl) {
...
function moonbitlang$core$set$$Set$add$0$(self, key) {
  moonbitlang$core$set$$Set$add_with_hash$0$(self, key, moonbitlang$core$builtin$$Hash$hash$32$(key));
}
function moonbitlang$core$set$$Set$add$6$(self, key) {
  moonbitlang$core$set$$Set$add_with_hash$6$(self, key, moonbitlang$core$builtin$$Hash$hash$33$(key));
}
...
function moonbitlang$core$set$$Set$contains$0$(self, key) {
  ...
  while (true) {
    ...
    if (_bind$8 === undefined) {
      ...
      const _Some = _bind$8;
      const _entry = _Some;
      if (_entry.hash === hash && moonbitlang$core$builtin$$Eq$op_equal$0$(_entry.key, key)) {
        return true;
      }
      if (i > _entry.psl) {
        return false;
...
function moonbitlang$core$builtin$$UninitializedArray$unsafe_blit$40$(dst, dst_offset, src, src_offset, len) {
...
function moonbitlang$core$builtin$$Show$to_string$45$(self) {
  ...
  moonbitlang$core$builtin$$Show$output$41$(self, { self: logger, method_0: moonbitlang$core$builtin$$Logger$write_string$28$, method_1: moonbitlang$core$builtin$$Logger$write_substring$28$, method_2: moonbitlang$core$builtin$$Logger$write_char$28$ });
  return logger.val;
}
function moonbitlang$core$builtin$$Show$to_string$46$(self) {
  const logger = moonbitlang$core$builtin$$StringBuilder$new$46$inner(0);
  moonbitlang$core$builtin$$Show$output$47$(self, { self: logger, method_0: moonbitlang$core$builtin$$Logger$write_string$28$, method_1: moonbitlang$core$builtin$$Logger$write_substring$28$, method_2: moonbitlang$core$builtin$$Logger$write_char$28$ });
  return logger.val;
}
...
function moonbitlang$core$int$$Int$output$46$inner(self, logger, radix) {
  ...
  moonbitlang$core$builtin$$output$46$inner$46$write_digits$124$1879(_env, self < 0 ? 0 - self | 0 : self);
}
...
function moonbitlang$core$builtin$$Map$set$53$(self, key, value) {
  moonbitlang$core$builtin$$Map$set_with_hash$53$(self, key, value, moonbitlang$core$builtin$$Hash$hash$44$(key));
}
function moonbitlang$core$builtin$$Map$set$1$(self, key, value) {
  moonbitlang$core$builtin$$Map$set_with_hash$1$(self, key, value, moonbitlang$core$builtin$$Hash$hash$44$(key));
}
function moonbitlang$core$builtin$$Map$set$2$(self, key, value) {
  moonbitlang$core$builtin$$Map$set_with_hash$2$(self, key, value, moonbitlang$core$builtin$$Hash$hash$44$(key));
}
...
function moonbitlang$core$builtin$$Map$set$9$(self, key, value) {
  moonbitlang$core$builtin$$Map$set_with_hash$9$(self, key, value, moonbitlang$core$builtin$$Hash$hash$33$(key));
}
function moonbitlang$core$builtin$$Map$from_array$53$(arr) {
  const m = moonbitlang$core$builtin$$Map$new$46$inner$53$(arr.length);
  const _p = arr.length;
  let _tmp = 0;
  while (true) {
    const _p$2 = _tmp;
    if (_p$2 < _p) {
      const _p$3 = arr[_p$2];
      moonbitlang$core$builtin$$Map$set$53$(m, _p$3._0, _p$3._1);
      _tmp = _p$2 + 1 | 0;
      continue;
    } else {
      break;
...
function moonbitlang$core$builtin$$Map$op_set$53$(self, key, value) {
  moonbitlang$core$builtin$$Map$set$53$(self, key, value);
}
...
function moonbitlang$core$builtin$$Add$op_add$35$(self, other) {
  return moonbitlang$core$builtin$$Add$op_add$61$(self, other);
}
function moonbitlang$core$builtin$$Sub$op_sub$35$(self, other) {
  return moonbitlang$core$builtin$$Sub$op_sub$61$(self, other);
}
function moonbitlang$core$builtin$$Mul$op_mul$35$(self, other) {
  return moonbitlang$core$builtin$$Mul$op_mul$61$(self, other);
}
function moonbitlang$core$builtin$$Mod$op_mod$35$(self, other) {
...
function moonbitlang$core$builtin$$Shl$op_shl$35$(self, shift) {
  return moonbitlang$core$builtin$$MyInt64$lsl(self, shift);
}
function moonbitlang$core$builtin$$Shr$op_shr$35$(self, shift) {
...
function moonbitlang$core$array$$FixedArray$blit_to$46$inner$38$(self, dst, len, src_offset, dst_offset) {
  if (dst_offset >= 0 && (src_offset >= 0 && ((dst_offset + len | 0) <= dst.length && (src_offset + len | 0) <= self.length))) {
    moonbitlang$core$array$$FixedArray$unsafe_blit$38$(dst, dst_offset, self, src_offset, len);
    return;
  } else {
...
function moonbitlang$core$array$$ArrayView$op_get$22$(self, index) {
  if (index >= 0 && index < self.len) {
    const _tmp = self.buf;
    const _tmp$2 = self.start + index | 0;
    $bound_check(_tmp, _tmp$2);
...
function moonbitlang$core$array$$ArrayView$op_as_view$46$inner$20$(self, start, end) {
  const len = self.len;
  let end$2;
  if (end === undefined) {
    end$2 = len;
...
function moonbitlang$core$array$$ArrayView$op_as_view$46$inner$22$(self, start, end) {
  const len = self.len;
  let end$2;
  if (end === undefined) {
    end$2 = len;
...
function moonbitlang$core$array$$Array$get$43$(self, index) {
  const len = self.length;
  return index >= 0 && index < len ? self[index] : undefined;
}
function moonbitlang$core$builtin$$Add$op_add$62$(self, other) {
  const result = new Array(self.length + other.length | 0);
  moonbitlang$core$builtin$$UninitializedArray$unsafe_blit$40$(result, 0, self, 0, self.length);
  moonbitlang$core$builtin$$UninitializedArray$unsafe_blit$40$(result, self.length, other, 0, other.length);
  return result;
}
...
function moonbitlang$core$builtin$$Add$op_add$64$(self, other) {
  const result = new Array(self.length + other.length | 0);
...
function moonbitlang$core$list$$of$8$(arr) {
...
function moonbitlang$core$random$$Source$next$66$(self) {
  while (true) {
...
function moonbitlang$core$random$$Rand$chacha8$46$inner(seed) {
  ...
  return { self: moonbitlang$core$random$internal$random_source$$ChaCha8$new(seed), method_0: moonbitlang$core$random$$Source$next$66$ };
}
function moonbitlang$core$random$$umul128(a, b) {
  const aLo = moonbitlang$core$builtin$$BitAnd$land$35$(a, $4294967295L);
  const aHi = moonbitlang$core$builtin$$Shr$op_shr$35$(a, 32);
  const bLo = moonbitlang$core$builtin$$BitAnd$land$35$(b, $4294967295L);
  const bHi = moonbitlang$core$builtin$$Shr$op_shr$35$(b, 32);
  const x = moonbitlang$core$builtin$$Mul$op_mul$35$(aLo, bLo);
  const y = moonbitlang$core$builtin$$Add$op_add$35$(moonbitlang$core$builtin$$Mul$op_mul$35$(aHi, bLo), moonbitlang$core$builtin$$Shr$op_shr$35$(x, 32));
  const z = moonbitlang$core$builtin$$Add$op_add$35$(moonbitlang$core$builtin$$Mul$op_mul$35$(aLo, bHi), moonbitlang$core$builtin$$BitAnd$land$35$(y, $4294967295L));
  const w = moonbitlang$core$builtin$$Add$op_add$35$(moonbitlang$core$builtin$$Add$op_add$35$(moonbitlang$core$builtin$$Mul$op_mul$35$(aHi, bHi), moonbitlang$core$builtin$$Shr$op_shr$35$(y, 32)), moonbitlang$core$builtin$$Shr$op_shr$35$(z, 32));
  return { hi: w, lo: moonbitlang$core$builtin$$Mul$op_mul$35$(a, b) };
}
function moonbitlang$core$random$$Rand$uint64$46$inner(self, limit) {
  if (moonbitlang$core$builtin$$Eq$op_equal$35$(limit, $0L)) {
    const _p = self;
    return _p.method_0(_p.self);
  } else {
    if (moonbitlang$core$builtin$$Eq$op_equal$35$(moonbitlang$core$builtin$$BitAnd$land$35$(limit, moonbitlang$core$builtin$$Sub$op_sub$35$(limit, $1L)), $0L)) {
      const _p = self;
      return moonbitlang$core$builtin$$BitAnd$land$35$(_p.method_0(_p.self), moonbitlang$core$builtin$$Sub$op_sub$35$(limit, $1L));
    }
  }
  const _p = self;
  let r = moonbitlang$core$random$$umul128(_p.method_0(_p.self), limit);
  if (moonbitlang$core$builtin$$op_lt$35$(r.lo, limit)) {
    const thresh = moonbitlang$core$builtin$$Mod$op_mod$35$(moonbitlang$core$uint64$$UInt64$lnot(limit), limit);
    while (true) {
      if (moonbitlang$core$builtin$$op_lt$35$(r.lo, thresh)) {
        const _p$2 = self;
...
function moonbitlang$core$random$$Rand$int$46$inner(self, limit) {
  if (limit === 0) {
    const _p = self;
    return moonbitlang$core$uint64$$UInt64$to_int(moonbitlang$core$builtin$$Shr$op_shr$35$(_p.method_0(_p.self), 33));
  } else {
...
function moonbitlang$core$random$internal$random_source$$ChaCha8$new(seed) {
  const seed$2 = moonbitlang$core$array$$FixedArray$makei$31$(8, (i) => moonbitlang$core$bytes$$View$to_uint_le(moonbitlang$core$bytes$$Bytes$op_as_view$46$inner(seed, Math.imul(i, 4) | 0, (Math.imul(i, 4) | 0) + 4 | 0)));
...
function moonbitlang$core$random$internal$random_source$$ChaCha8$next(self) {
  ...
  return moonbitlang$core$builtin$$BitOr$lor$35$(moonbitlang$core$builtin$$Shl$op_shl$35$(hi, 32), lo);
}
function moonbitlang$core$random$internal$random_source$$ChaCha8$refill(self) {
  self.counter = (self.counter >>> 0) + (4 >>> 0) | 0;
  if (self.counter === 16) {
    moonbitlang$core$array$$FixedArray$blit_to$46$inner$38$(self.buffer, self.seed, 8, 56, 0);
    self.counter = 0;
  }
...
function moonbitlang$core$builtin$$Hash$hash_combine$6$(_x_129, _x_130) {
  moonbitlang$core$builtin$$Hash$hash_combine$38$(_x_129, _x_130);
}
function moonbitlang$core$builtin$$Eq$op_equal$0$(_x_125, _x_126) {
  switch (_x_125) {
    case 0: {
      if (_x_126 === 0) {
        return true;
...
function Milky2018$selene$sprite$$render_animation(backend, animation, current_frame, pos, visible) {
  const frame = moonbitlang$core$array$$Array$op_get$42$(animation.frames, moonbitlang$core$double$$Double$to_int(current_frame));
  if (visible) {
...
function Milky2018$selene$sprite$$render_sprite_system(backend) {
  ...
  const sprites = _p$2;
  moonbitlang$core$array$$Array$sort_by_key$30$(sprites, (pair) => pair._1.zindex);
...
function Milky2018$selene$collision$$quadtree_query(area) {
  const trees = { val: moonbitlang$core$list$$of$8$([Milky2018$selene$collision$$quadtree_root.val]) };
...
function Milky2018$selene$collision$$add_collision_info(entity, target, direction) {
  ...
  if (_bind$8.$tag === 0) {
    moonbitlang$core$builtin$$Map$set$9$(Milky2018$selene$collision$$collision_infos, entity, moonbitlang$core$array$$Array$new$46$inner$60$(0));
  }
  moonbitlang$core$array$$Array$push$60$(moonbitlang$core$option$$Option$unwrap$52$(moonbitlang$core$builtin$$Map$get$9$(Milky2018$selene$collision$$collision_infos, entity)), { entity: target, direction: direction });
}
...
function Milky2018$selene$plugins$$default_plugin(app) {
  ...
  moonbitlang$core$array$$Array$push$57$(_self, { _0: Milky2018$selene$system$$advanced_key_system, _1: $64$Milky2018$47$selene$47$system$46$Schedule$Update, _2: "Advanced Key System" });
  moonbitlang$core$array$$Array$push$57$(_self, { _0: Milky2018$selene$system$$advanced_mouse_system, _1: $64$Milky2018$47$selene$47$system$46$Schedule$Update, _2: "Advanced Mouse System" });
  ...
  moonbitlang$core$array$$Array$push$57$(_self, { _0: Milky2018$selene$sprite$$render_sprite_system, _1: new $64$Milky2018$47$selene$47$system$46$Schedule$Render(0), _2: "Render Sprite System" });
...
function rami3l$js$45$ffi$js$$Union3$from0$67$(value) {
  return value;
}
function rami3l$js$45$ffi$js$$Union3$from1$67$(value) {
  return value;
}
function rami3l$js$45$ffi$js$$Union3$from2$67$(value) {
  return value;
}
function rami3l$js$45$ffi$js$$Union5$to0$68$(self) {
  return rami3l$js$45$ffi$js$$Cast$into$49$(self);
}
function rami3l$js$45$ffi$js$$Union7$from0$69$(value) {
  return rami3l$js$45$ffi$js$$Cast$from$70$(value);
}
function rami3l$js$45$ffi$js$$Optional$undefined$71$() {
...
function rami3l$js$45$ffi$js$$Cast$from$70$(value) {
  return value;
}
...
function Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$fill_text(self, text, x, y, max_width$46$opt) {
  ...
  if (max_width$46$opt.$tag === 1) {
    ...
    max_width = rami3l$js$45$ffi$js$$Optional$undefined$71$();
  }
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$fill_text$46$inner(self, text, x, y, max_width);
}
function Milky2018$selene$system$$Backend$register_mouse_events$78$(self, mouse, mouse_movement) {
  self.mouse_movement.val = mouse_movement;
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$74$(Milky2018$selene$45$canvas$$window, "mousemove", (event) => {
    const mouse_event = moonbitlang$core$option$$Option$unwrap$51$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_mouse_event$77$(event));
  ...
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$74$(Milky2018$selene$45$canvas$$window, "mousedown", (event) => {
    const mouse_event = moonbitlang$core$option$$Option$unwrap$51$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_mouse_event$77$(event));
  ...
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$74$(Milky2018$selene$45$canvas$$window, "mouseup", (event) => {
    const mouse_event = moonbitlang$core$option$$Option$unwrap$51$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_mouse_event$77$(event));
    const _bind$8 = Yoorkin$rabbit$45$tea$dom$$IsMouseEvent$get_button$73$(mouse_event);
    switch (_bind$8) {
      case 0: {
...
function Milky2018$selene$system$$Backend$lock_mouse$78$(self, locked) {
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$75$(self.canvas, "click", (_event) => {
...
function Milky2018$selene$system$$Backend$register_key_events$78$(_self, pressed_keys) {
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$74$(Milky2018$selene$45$canvas$$window, "keyup", (event) => {
    const keyboard_event = moonbitlang$core$option$$Option$unwrap$50$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_keyboard_event$77$(event));
  ...
  Yoorkin$rabbit$45$tea$dom$$IsEventTarget$add_event_listener$74$(Milky2018$selene$45$canvas$$window, "keydown", (event) => {
    const keyboard_event = moonbitlang$core$option$$Option$unwrap$50$(Yoorkin$rabbit$45$tea$dom$$IsEvent$to_keyboard_event$77$(event));
    const keycode = Milky2018$selene$system$$Code$from_string(Yoorkin$rabbit$45$tea$dom$$KeyboardEvent$code(keyboard_event));
    if (keycode === undefined) {
      return;
...
function Milky2018$selene$system$$Backend$preload_img$78$(_self, path) {
  Milky2018$selene$45$canvas$$get_image_element(path);
}
function Milky2018$selene$system$$Backend$draw_picture$78$(self, png, x, y, width, height, transform, repeat) {
  ...
  const pattern = Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$create_pattern(self.context, rami3l$js$45$ffi$js$$Union7$from0$69$(element), repeat_mode);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$save(self.context);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$set_fill_style(self.context, rami3l$js$45$ffi$js$$Union3$from2$67$(pattern));
...
function Milky2018$selene$system$$Backend$draw_sprite$78$(self, sprite_path, x, y, offset_x, offset_y, width, height, transform) {
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$save(self.context);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$translate(self.context, x, y);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$transform(self.context, transform.a, transform.b, transform.c, transform.d, transform.tx, transform.ty);
...
function Milky2018$selene$system$$Backend$draw_stroke_rect$78$(self, x, y, width, height, color) {
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$save(self.context);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$set_stroke_style(self.context, rami3l$js$45$ffi$js$$Union3$from0$67$(color));
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$stroke_rect(self.context, x, y, width, height);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$restore(self.context);
}
function Milky2018$selene$system$$Backend$draw_text$78$(self, text, x, y, font, color) {
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$save(self.context);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$set_font(self.context, font);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$set_fill_style(self.context, rami3l$js$45$ffi$js$$Union3$from0$67$(color));
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$fill_text(self.context, text, x, y, Option$None$11$);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$restore(self.context);
}
function Milky2018$selene$system$$Backend$draw_color_rect$78$(self, x, y, width, height, color) {
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$save(self.context);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$set_fill_style(self.context, rami3l$js$45$ffi$js$$Union3$from0$67$(color));
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$fill_rect(self.context, x, y, width, height);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$restore(self.context);
}
function Milky2018$selene$system$$Backend$draw_gradient_rect$78$(self, x, y, width, height, color_start, color_end) {
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$save(self.context);
  ...
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$set_fill_style(self.context, rami3l$js$45$ffi$js$$Union3$from1$67$(gradient));
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$fill_rect(self.context, x, y, width, height);
  Yoorkin$rabbit$45$tea$dom$$CanvasRenderingContext2D$restore(self.context);
}
function Milky2018$selene$45$canvas$$CanvasBackend$new() {
  const canvas = moonbitlang$core$option$$Option$unwrap$48$(Yoorkin$rabbit$45$tea$dom$$IsEventTarget$to_html_canvas_element$76$(rami3l$js$45$ffi$js$$Nullable$unwrap$72$(Yoorkin$rabbit$45$tea$dom$$Document$get_element_by_id(Yoorkin$rabbit$45$tea$dom$$document(), "canvas"))));
  const context = moonbitlang$core$option$$Option$unwrap$49$(rami3l$js$45$ffi$js$$Union5$to0$68$(Yoorkin$rabbit$45$tea$dom$$HTMLCanvasElement$get_context(canvas, "2d")));
  const _bind$8 = { _0: 0, _1: 0 };
  const _bind$9 = moonbitlang$core$builtin$$Map$from_array$53$([]);
...
function Milky2018$selene$system$$Backend$build$78$(self, systems, canvas_width, canvas_height, fps, image_smooth, zoom) {
  if (fps >>> 0 > 60 >>> 0) {
  ...
  while (true) {
    ...
    if (_i < _len) {
      ...
      if (_bind$8.$tag === 0) {
        ...
        _func({ self: self, method_0: Milky2018$selene$system$$Backend$build$78$, method_1: Milky2018$selene$system$$Backend$draw_picture$78$, method_2: Milky2018$selene$system$$Backend$draw_sprite$78$, method_3: Milky2018$selene$system$$Backend$register_key_events$78$, method_4: Milky2018$selene$system$$Backend$register_mouse_events$78$, method_5: Milky2018$selene$system$$Backend$lock_mouse$78$, method_6: Milky2018$selene$system$$Backend$draw_stroke_rect$78$, method_7: Milky2018$selene$system$$Backend$draw_text$78$, method_8: Milky2018$selene$system$$Backend$draw_color_rect$78$, method_9: Milky2018$selene$system$$Backend$draw_gradient_rect$78$, method_10: Milky2018$selene$system$$Backend$play_audio$78$, method_11: Milky2018$selene$system$$Backend$get_canvas_size$78$, method_12: Milky2018$selene$system$$Backend$get_zoom$78$, method_13: Milky2018$selene$system$$Backend$get_debug_info$78$, method_14: Milky2018$selene$system$$Backend$preload_img$78$, method_15: Milky2018$selene$system$$Backend$preload_audio$78$ });
      }
      _tmp = _i + 1 | 0;
      continue;
    } else {
  ...
  Milky2018$selene$45$canvas$$schedule_with_fixed_interval(1000 / $f64_convert_i32_u(fps), (delta) => {
      ...
      if (_i < _len$2) {
        ...
        switch (_bind$8.$tag) {
          case 3: {
            ...
            if (moonbitlang$core$builtin$$Eq$op_equal$35$(moonbitlang$core$builtin$$Mod$op_mod$35$(self.frame_counter, moonbitlang$core$uint$$UInt$to_uint64(_frame_period)), $0L)) {
              const _func = system._0;
              _func({ self: self, method_0: Milky2018$selene$system$$Backend$build$78$, method_1: Milky2018$selene$system$$Backend$draw_picture$78$, method_2: Milky2018$selene$system$$Backend$draw_sprite$78$, method_3: Milky2018$selene$system$$Backend$register_key_events$78$, method_4: Milky2018$selene$system$$Backend$register_mouse_events$78$, method_5: Milky2018$selene$system$$Backend$lock_mouse$78$, method_6: Milky2018$selene$system$$Backend$draw_stroke_rect$78$, method_7: Milky2018$selene$system$$Backend$draw_text$78$, method_8: Milky2018$selene$system$$Backend$draw_color_rect$78$, method_9: Milky2018$selene$system$$Backend$draw_gradient_rect$78$, method_10: Milky2018$selene$system$$Backend$play_audio$78$, method_11: Milky2018$selene$system$$Backend$get_canvas_size$78$, method_12: Milky2018$selene$system$$Backend$get_zoom$78$, method_13: Milky2018$selene$system$$Backend$get_debug_info$78$, method_14: Milky2018$selene$system$$Backend$preload_img$78$, method_15: Milky2018$selene$system$$Backend$preload_audio$78$ });
              moonbitlang$core$builtin$$Map$op_set$53$(self.execution_time, system._2, Milky2018$selene$45$canvas$$time_now() - start_time);
            }
            break;
          }
          case 2: {
          ...
          case 4: {
            ...
            if (moonbitlang$core$builtin$$Eq$op_equal$35$(moonbitlang$core$builtin$$Mod$op_mod$35$(self.frame_counter, moonbitlang$core$double$$Double$to_uint64($f64_convert_i32_u(fps) * _period)), $0L)) {
              const _func$2 = system._0;
              _func$2({ self: self, method_0: Milky2018$selene$system$$Backend$build$78$, method_1: Milky2018$selene$system$$Backend$draw_picture$78$, method_2: Milky2018$selene$system$$Backend$draw_sprite$78$, method_3: Milky2018$selene$system$$Backend$register_key_events$78$, method_4: Milky2018$selene$system$$Backend$register_mouse_events$78$, method_5: Milky2018$selene$system$$Backend$lock_mouse$78$, method_6: Milky2018$selene$system$$Backend$draw_stroke_rect$78$, method_7: Milky2018$selene$system$$Backend$draw_text$78$, method_8: Milky2018$selene$system$$Backend$draw_color_rect$78$, method_9: Milky2018$selene$system$$Backend$draw_gradient_rect$78$, method_10: Milky2018$selene$system$$Backend$play_audio$78$, method_11: Milky2018$selene$system$$Backend$get_canvas_size$78$, method_12: Milky2018$selene$system$$Backend$get_zoom$78$, method_13: Milky2018$selene$system$$Backend$get_debug_info$78$, method_14: Milky2018$selene$system$$Backend$preload_img$78$, method_15: Milky2018$selene$system$$Backend$preload_audio$78$ });
              moonbitlang$core$builtin$$Map$op_set$53$(self.execution_time, system._2, Milky2018$selene$45$canvas$$time_now() - start_time);
            }
            break;
          }
    ...
    self.frame_counter = moonbitlang$core$builtin$$Add$op_add$35$(self.frame_counter, $1L);
  });
  return () => {
  };
}
function Milky2018$selene$system$$Backend$get_canvas_size$78$(self) {
...
function Milky2018$selene$system$$Backend$get_debug_info$78$(self) {
  return { system_execution_time: self.execution_time, fps: self.current_fps };
}
function Milky2018$selene$system$$Backend$get_zoom$78$(self) {
  return self.zoom;
}
...
function Milky2018$selene$system$$Backend$play_audio$78$(_self, audio_path, volume, loop_) {
...
function KrystalRay$pokemoon$$create_debug_input_handler() {
  return { key_states: moonbitlang$core$builtin$$Map$new$46$inner$54$(8), mouse_buttons: moonbitlang$core$builtin$$Map$new$46$inner$55$(8), mouse_position: { _0: 0, _1: 0 }, event_queue: [] };
}
...
function KrystalRay$pokemoon$$add_test_result(screen, result) {
  return { is_active: screen.is_active, current_test: screen.current_test, test_results: moonbitlang$core$builtin$$Add$op_add$63$(screen.test_results, [result]), frame_count: screen.frame_count, fps_counter: screen.fps_counter, fps: screen.fps, debug_entity: screen.debug_entity, debug_text_entities: screen.debug_text_entities };
}
...
function KrystalRay$pokemoon$$create_turn_display() {
  ...
  return { background_entity: background_entity, turn_text_entity: turn_text_entity, turn_number_entity: turn_number_entity };
}
function KrystalRay$pokemoon$$update_turn_display(current_turn, current_turn_type) {
  ...
  if (_bind$8 === undefined) {
    ...
    moonbitlang$core$builtin$$Map$set$3$(Milky2018$selene$position$$positions, _turn_display.turn_number_entity, { _0: bg_vec._0 + number_offset_x, _1: bg_vec._1 + 20 });
    moonbitlang$core$builtin$$println$27$(`📊 回合显示更新完成: ${turn_type_text} ${turn_number}, 背景宽度: ${String(background_width)}`);
    return;
  }
}
function KrystalRay$pokemoon$$init_turn_display_system() {
  ...
  moonbitlang$core$builtin$$println$27$("回合显示创建成功");
...
function KrystalRay$pokemoon$$create_pokemon_info_template(config, pokemon_name, pokemon_level, max_hp) {
  ...
  const name_sprite = Milky2018$selene$sprite$$Sprite$from_text(Milky2018$selene$sprite$$Text$new$46$inner(pokemon_name, "white", "16px Arial"), 20, undefined);
  ...
  const level_sprite = Milky2018$selene$sprite$$Sprite$from_text(Milky2018$selene$sprite$$Text$new$46$inner(`Lv.${moonbitlang$core$int$$Int$to_string$46$inner(pokemon_level, 10)}`, "white", "14px Arial"), 20, undefined);
...
function KrystalRay$pokemoon$$update_pokemon_info_display(pokemon_info, pokemon_name, pokemon_level, current_hp, max_hp) {
  ...
  const fill_color = clamped_percentage > 0.5 ? (moonbitlang$core$builtin$$Eq$op_equal$79$(pokemon_info.bar_type, 0) ? "#00FF00" : "#FF0000") : clamped_percentage > 0.25 ? "#FFFF00" : "#FF0000";
  ...
  const text_color = clamped_percentage < 0.33 ? "#FF0000" : "#FFFFFF";
...
function KrystalRay$pokemoon$$get_skill_data() {
  return [{ name: "藤蔓缠绕", power: 60, accuracy: 95, move_type: 0, element_type: "Grass", pp: 20, max_pp: 20 }, { name: "数据流", power: 70, accuracy: 100, move_type: 1, element_type: "Dragon", pp: 15, max_pp: 15 }, { name: "优雅编程", power: 80, accuracy: 90, move_type: 1, element_type: "Grass", pp: 10, max_pp: 10 }, { name: "简洁代码", power: 50, accuracy: 100, move_type: 2, element_type: "Normal", pp: 25, max_pp: 25 }, { name: "热咖啡", power: 65, accuracy: 100, move_type: 1, element_type: "Fire", pp: 20, max_pp: 20 }, { name: "企业级攻击", power: 90, accuracy: 85, move_type: 0, element_type: "Steel", pp: 10, max_pp: 10 }, { name: "持久战", power: 0, accuracy: 100, move_type: 2, element_type: "Steel", pp: 15, max_pp: 15 }, { name: "跨平台", power: 75, accuracy: 95, move_type: 1, element_type: "Fire", pp: 15, max_pp: 15 }, { name: "指针攻击", power: 85, accuracy: 90, move_type: 0, element_type: "Steel", pp: 15, max_pp: 15 }, { name: "内存泄漏", power: 0, accuracy: 100, move_type: 2, element_type: "Dark", pp: 10, max_pp: 10 }, { name: "模板编程", power: 95, accuracy: 80, move_type: 1, element_type: "Steel", pp: 8, max_pp: 8 }, { name: "齿轮切割", power: 70, accuracy: 100, move_type: 0, element_type: "Steel", pp: 20, max_pp: 20 }, { name: "异步闪电", power: 80, accuracy: 95, move_type: 1, element_type: "Electric", pp: 15, max_pp: 15 }, { name: "原型链", power: 60, accuracy: 100, move_type: 1, element_type: "Fairy", pp: 20, max_pp: 20 }, { name: "回调攻击", power: 70, accuracy: 90, move_type: 1, element_type: "Electric", pp: 15, max_pp: 15 }, { name: "动态类型", power: 0, accuracy: 100, move_type: 2, element_type: "Fairy", pp: 25, max_pp: 25 }, { name: "音符冲击", power: 75, accuracy: 100, move_type: 1, element_type: "Electric", pp: 15, max_pp: 15 }, { name: "LINQ查询", power: 85, accuracy: 90, move_type: 1, element_type: "Steel", pp: 12, max_pp: 12 }, { name: "属性攻击", power: 65, accuracy: 100, move_type: 0, element_type: "Steel", pp: 18, max_pp: 18 }, { name: "委托技能", power: 0, accuracy: 100, move_type: 2, element_type: "Electric", pp: 20, max_pp: 20 }, { name: "并发挖掘", power: 60, accuracy: 100, move_type: 0, element_type: "Ground", pp: 20, max_pp: 20 }, { name: "协程", power: 0, accuracy: 100, move_type: 2, element_type: "Normal", pp: 15, max_pp: 15 }, { name: "快速编译", power: 70, accuracy: 100, move_type: 1, element_type: "Normal", pp: 15, max_pp: 15 }, { name: "垃圾回收", power: 0, accuracy: 100, move_type: 2, element_type: "Ground", pp: 10, max_pp: 10 }, { name: "所有权攻击", power: 90, accuracy: 95, move_type: 0, element_type: "Steel", pp: 10, max_pp: 10 }, { name: "借用检查", power: 0, accuracy: 100, move_type: 2, element_type: "Water", pp: 15, max_pp: 15 }, { name: "内存安全", power: 0, accuracy: 100, move_type: 2, element_type: "Steel", pp: 20, max_pp: 20 }, { name: "零成本抽象", power: 85, accuracy: 90, move_type: 1, element_type: "Water", pp: 12, max_pp: 12 }, { name: "宝石闪耀", power: 80, accuracy: 100, move_type: 1, element_type: "Fire", pp: 15, max_pp: 15 }, { name: "元编程", power: 95, accuracy: 85, move_type: 1, element_type: "Fairy", pp: 8, max_pp: 8 }, { name: "优雅语法", power: 70, accuracy: 100, move_type: 1, element_type: "Fire", pp: 18, max_pp: 18 }, { name: "动态方法", power: 75, accuracy: 95, move_type: 1, element_type: "Fairy", pp: 15, max_pp: 15 }, { name: "服务器守护", power: 0, accuracy: 100, move_type: 2, element_type: "Water", pp: 20, max_pp: 20 }, { name: "Web开发", power: 60, accuracy: 100, move_type: 1, element_type: "Water", pp: 20, max_pp: 20 }, { name: "数据库连接", power: 0, accuracy: 100, move_type: 2, element_type: "Ice", pp: 15, max_pp: 15 }, { name: "顽强生存", power: 50, accuracy: 100, move_type: 0, element_type: "Water", pp: 25, max_pp: 25 }, { name: "月光编译", power: 0, accuracy: 100, move_type: 2, element_type: "Psychic", pp: 10, max_pp: 10 }, { name: "代码幻象", power: 75, accuracy: 100, move_type: 1, element_type: "Psychic", pp: 10, max_pp: 10 }, { name: "星辰跃击", power: 95, accuracy: 90, move_type: 1, element_type: "Fairy", pp: 8, max_pp: 8 }, { name: "迅捷跃步", power: 60, accuracy: 100, move_type: 0, element_type: "Ground", pp: 20, max_pp: 20 }];
}
...
function KrystalRay$pokemoon$$find_skill_by_name(db, name) {
  ...
  while (true) {
    if (i < db.skills.length) {
      const skill = moonbitlang$core$array$$Array$op_get$43$(db.skills, i);
      if (skill.name === name) {
        result = skill;
        break;
      }
...
function KrystalRay$pokemoon$$create_move_from_name(move_name) {
  ...
  if (_bind$8 === undefined) {
    return { name: move_name, power: 50, accuracy: 100, move_type: 0, element_type: "Normal", pp: 20, max_pp: 20 };
  } else {
    const _Some = _bind$8;
    return _Some;
  }
...
function KrystalRay$pokemoon$$get_pokemon_moves(pokemon) {
  ...
  while (true) {
    ...
    if (_i < _len) {
      ...
      moonbitlang$core$array$$Array$push$43$(moves, KrystalRay$pokemoon$$create_move_from_name(move_name));
      _tmp = _i + 1 | 0;
      continue;
    } else {
      break;
...
function KrystalRay$pokemoon$$find_pokemon_by_id(db, id) {
  ...
  while (true) {
    if (i < db.pokemons.length) {
      const pokemon = moonbitlang$core$array$$Array$op_get$40$(db.pokemons, i);
      if (pokemon.id === id) {
        result = pokemon;
        break;
      }
    ...
    if (i < db.pokemons.length) {
      ...
      while (true) {
        if (j < pokemon.types.length) {
          if (moonbitlang$core$builtin$$Eq$op_equal$41$(moonbitlang$core$array$$Array$op_get$41$(pokemon.types, j), pokemon_type)) {
            found = true;
            break;
          }
          j = j + 1 | 0;
      ...
      if (found) {
        result = moonbitlang$core$builtin$$Add$op_add$62$(result, [pokemon]);
      }
      i = i + 1 | 0;
      continue;
    } else {
...
function KrystalRay$pokemoon$$display_pokemon_info(pokemon) {
  ...
  moonbitlang$core$builtin$$println$27$(`属性1: ${moonbitlang$core$builtin$$Show$to_string$45$(moonbitlang$core$array$$Array$op_get$41$(pokemon.types, 0))}`);
  const _bind$8 = pokemon.types.length;
  if (_bind$8 === 2) {
    moonbitlang$core$builtin$$println$27$(`属性2: ${moonbitlang$core$builtin$$Show$to_string$45$(moonbitlang$core$array$$Array$op_get$41$(pokemon.types, 1))}`);
  } else {
...
function KrystalRay$pokemoon$$display_all_pokemons(db) {
  ...
  while (true) {
    if (i < db.pokemons.length) {
      KrystalRay$pokemoon$$display_pokemon_info(moonbitlang$core$array$$Array$op_get$40$(db.pokemons, i));
      i = i + 1 | 0;
      continue;
    } else {
      return;
...
function KrystalRay$pokemoon$$test_and_print_pokemon_data() {
  ...
  while (true) {
    if (i < fire_pokemons.length) {
      const pokemon = moonbitlang$core$array$$Array$op_get$40$(fire_pokemons, i);
  ...
  while (true) {
    if (j < grass_pokemons.length) {
      const pokemon = moonbitlang$core$array$$Array$op_get$40$(grass_pokemons, j);
      moonbitlang$core$builtin$$println$27$(`  - ${pokemon.name} (Lv.${moonbitlang$core$int$$Int$to_string$46$inner(pokemon.level, 10)})`);
      j = j + 1 | 0;
      continue;
    } else {
...
function KrystalRay$pokemoon$$move_skill_selection_down() {
  ...
  if (current_moves.length > 0) {
    ...
    moonbitlang$core$builtin$$println$27$(`⬇️ 选择技能: ${moonbitlang$core$array$$Array$op_get$43$(current_moves, KrystalRay$pokemoon$$battle_render_state.skill_menu_selected).name}`);
    return;
  } else {
    return;
  }
...
function KrystalRay$pokemoon$$calculate_damage(attacker, defender, skill) {
  ...
  const modifier = KrystalRay$pokemoon$$get_type_effectiveness_multiplier(skill.element_type, defender.types);
  const final_damage = moonbitlang$core$double$$Double$to_int((damage_before_modifier + 0) * modifier);
  return final_damage < 1 ? 1 : final_damage;
}
function KrystalRay$pokemoon$$get_winner(battle_state) {
  const _bind$8 = battle_state.player_pokemon;
  const _bind$9 = battle_state.enemy_pokemon;
  if (_bind$8 === undefined) {
    return "Battle not properly initialized";
  } else {
    const _Some = _bind$8;
    const _player = _Some;
    if (_bind$9 === undefined) {
      ...
      return _player.hp <= 0 ? "Enemy wins!" : _enemy.hp <= 0 ? "Player wins!" : "Battle still in progress";
    }
  }
}
...
function KrystalRay$pokemoon$$is_enemy_turn() {
  ...
  if (_bind$8 === undefined) {
    ...
    const _Some = _bind$8;
    const _state = _Some;
    return moonbitlang$core$builtin$$Eq$op_equal$80$(_state.current_turn_type, 1);
  }
}
...
function KrystalRay$pokemoon$$increment_actions_this_turn() {
  ...
  if (_bind$8 === undefined) {
    ...
    const updated_state = { is_active: _state.is_active, turn: _state.turn, current_turn_type: _state.current_turn_type, player_pokemon: _state.player_pokemon, enemy_pokemon: _state.enemy_pokemon, battle_log: _state.battle_log, actions_this_turn: new_actions, max_actions_per_turn: _state.max_actions_per_turn };
    KrystalRay$pokemoon$$battle_render_state.battle_state = updated_state;
...
function KrystalRay$pokemoon$$render_enemy_pokemon(pokemon) {
  ...
  moonbitlang$core$builtin$$Map$set$3$(Milky2018$selene$position$$positions, entity, { _0: 666, _1: 70 });
...
function KrystalRay$pokemoon$$render_pokemon_status(pokemon, position, is_enemy) {
  const config = is_enemy ? { base_position: position, width: 200, height: 20, background_color: "#333333", fill_color: "#FF0000", text_color: "#FFFFFF", bar_type: 1 } : { base_position: position, width: 200, height: 20, background_color: "#333333", fill_color: "#00FF00", text_color: "#FFFFFF", bar_type: 0 };
  ...
  moonbitlang$core$builtin$$println$27$(` 宝可梦状态渲染完成: ${pokemon.name} Lv.${moonbitlang$core$int$$Int$to_string$46$inner(pokemon.level, 10)}`);
}
...
function KrystalRay$pokemoon$$execute_battle_skill(skill, is_player_attacking) {
  ...
  const _bind$8 = KrystalRay$pokemoon$$battle_render_state.current_player_pokemon;
  if (_bind$8 === undefined) {
    moonbitlang$core$builtin$$println$27$("❌ 没有找到玩家宝可梦");
    return;
  } else {
    const _Some = _bind$8;
    const _player_pokemon = _Some;
    const _bind$9 = KrystalRay$pokemoon$$battle_render_state.current_enemy_pokemon;
    if (_bind$9 === undefined) {
      moonbitlang$core$builtin$$println$27$("❌ 没有找到敌方宝可梦");
      return;
    } else {
      const _Some$2 = _bind$9;
      const _enemy_pokemon = _Some$2;
      let attacker;
      let defender;
      _L: {
        if (is_player_attacking) {
          attacker = _player_pokemon;
          defender = _enemy_pokemon;
          break _L;
        } else {
          attacker = _enemy_pokemon;
          defender = _player_pokemon;
          break _L;
        }
      }
      const damage = KrystalRay$pokemoon$$calculate_damage(attacker, defender, skill);
      ...
      if (is_player_attacking) {
        KrystalRay$pokemoon$$battle_render_state.current_enemy_pokemon = updated_defender;
        const _bind$10 = KrystalRay$pokemoon$$battle_render_state.battle_state;
        if (_bind$10 === undefined) {
        } else {
          const _Some$3 = _bind$10;
          const _state = _Some$3;
          const updated_battle_state = { is_active: _state.is_active, turn: _state.turn, current_turn_type: _state.current_turn_type, player_pokemon: _state.player_pokemon, enemy_pokemon: updated_defender, battle_log: _state.battle_log, actions_this_turn: _state.actions_this_turn, max_actions_per_turn: _state.max_actions_per_turn };
          KrystalRay$pokemoon$$battle_render_state.battle_state = updated_battle_state;
        }
        const _bind$11 = KrystalRay$pokemoon$$battle_render_state.enemy_pokemon_info;
        if (_bind$11 === undefined) {
          moonbitlang$core$builtin$$println$27$("❌ 敌方宝可梦信息显示未创建");
        } else {
          const _Some$3 = _bind$11;
          const _pokemon_info = _Some$3;
          KrystalRay$pokemoon$$update_pokemon_info_display(_pokemon_info, updated_defender.name, updated_defender.level, updated_defender.hp, updated_defender.max_hp);
        }
      } else {
        KrystalRay$pokemoon$$battle_render_state.current_player_pokemon = updated_defender;
        const _bind$10 = KrystalRay$pokemoon$$battle_render_state.battle_state;
        if (_bind$10 === undefined) {
        } else {
          const _Some$3 = _bind$10;
          const _state = _Some$3;
          const updated_battle_state = { is_active: _state.is_active, turn: _state.turn, current_turn_type: _state.current_turn_type, player_pokemon: updated_defender, enemy_pokemon: _state.enemy_pokemon, battle_log: _state.battle_log, actions_this_turn: _state.actions_this_turn, max_actions_per_turn: _state.max_actions_per_turn };
          KrystalRay$pokemoon$$battle_render_state.battle_state = updated_battle_state;
        }
        const _bind$11 = KrystalRay$pokemoon$$battle_render_state.player_pokemon_info;
        if (_bind$11 === undefined) {
          moonbitlang$core$builtin$$println$27$("❌ 玩家宝可梦信息显示未创建");
        } else {
          const _Some$3 = _bind$11;
          const _pokemon_info = _Some$3;
          KrystalRay$pokemoon$$update_pokemon_info_display(_pokemon_info, updated_defender.name, updated_defender.level, updated_defender.hp, updated_defender.max_hp);
      ...
      const damage_message = `${attacker.name} 使用了 ${skill.name}! 对 ${defender.name} 造成了 ${moonbitlang$core$int$$Int$to_string$46$inner(damage, 10)} 点伤害!`;
      moonbitlang$core$builtin$$println$27$(` ${damage_message}`);
      KrystalRay$pokemoon$$update_text_box(damage_message);
      if (new_defender_hp <= 0) {
        const victory_message = `${defender.name} 被击败了! ${attacker.name} 获胜!`;
      ...
      _L$2: {
        if (is_player_attacking) {
          updated_player = _player_pokemon;
          updated_enemy = updated_defender;
          break _L$2;
        } else {
          updated_player = updated_defender;
          updated_enemy = _enemy_pokemon;
          break _L$2;
        }
      }
      KrystalRay$pokemoon$$render_pokemon(updated_player, updated_enemy);
...
function KrystalRay$pokemoon$$end_current_turn() {
  ...
  if (_bind$8 === undefined) {
    ...
    if (KrystalRay$pokemoon$$is_battle_finished(_state)) {
      const winner = KrystalRay$pokemoon$$get_winner(_state);
      moonbitlang$core$builtin$$println$27$(` 战斗结束! ${winner}`);
      KrystalRay$pokemoon$$update_text_box(`战斗结束! ${winner}`);
      const ended_state = { is_active: false, turn: _state.turn, current_turn_type: _state.current_turn_type, player_pokemon: _state.player_pokemon, enemy_pokemon: _state.enemy_pokemon, battle_log: _state.battle_log, actions_this_turn: _state.actions_this_turn, max_actions_per_turn: _state.max_actions_per_turn };
      KrystalRay$pokemoon$$battle_render_state.battle_state = ended_state;
      return undefined;
    }
...
function KrystalRay$pokemoon$$execute_enemy_turn() {
  ...
  if (_bind$8 === undefined) {
    ...
    if (moves.length > 0) {
      const rng = moonbitlang$core$random$$Rand$chacha8$46$inner($bytes_literal$0);
      const random_index = moonbitlang$core$random$$Rand$int$46$inner(rng, moves.length);
...
function KrystalRay$pokemoon$$update_indicator_position(selection) {
  ...
  moonbitlang$core$builtin$$println$27$(`🎯 箭头位置更新: (${String(indicator_pos._0)}, ${String(indicator_pos._1)}) - ${moonbitlang$core$builtin$$Show$to_string$46$(selection)}`);
}
...
function KrystalRay$pokemoon$$create_skill_list_entities(moves) {
  ...
  while (true) {
    const i = _tmp;
    if (i < moves.length) {
      const move = moonbitlang$core$array$$Array$op_get$43$(moves, i);
      ...
      skill_entities = moonbitlang$core$builtin$$Add$op_add$64$(skill_entities, [skill_entity]);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function KrystalRay$pokemoon$$is_player_turn() {
  ...
  if (_bind$8 === undefined) {
    ...
    const _Some = _bind$8;
    const _state = _Some;
    return moonbitlang$core$builtin$$Eq$op_equal$80$(_state.current_turn_type, 0);
  }
}
...
function KrystalRay$pokemoon$$create_battle_background() {
  ...
  const background_sprite = Milky2018$selene$sprite$$Sprite$from_color_rect(Milky2018$selene$sprite$$ColorRect$new({ _0: 800, _1: 450 }, "#90EE90"), 0, undefined);
...
function KrystalRay$pokemoon$$start_battle_render(player_pokemon, enemy_pokemon) {
  ...
  const initial_battle_state = { is_active: true, turn: 1, current_turn_type: 0, player_pokemon: player_pokemon, enemy_pokemon: enemy_pokemon, battle_log: [], actions_this_turn: 0, max_actions_per_turn: 1 };
